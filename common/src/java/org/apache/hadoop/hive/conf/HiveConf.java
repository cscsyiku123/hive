...
public class HiveConf extends Configuration {
     ...
     */
    public static final HiveConf.ConfVars[] metaVars = {HiveConf.ConfVars.METASTOREWAREHOUSE, HiveConf.ConfVars.REPLDIR,
            HiveConf.ConfVars.METASTOREURIS, HiveConf.ConfVars.METASTORE_SERVER_PORT, HiveConf.ConfVars.METASTORETHRIFTCONNECTIONRETRIES,
            HiveConf.ConfVars.METASTORETHRIFTFAILURERETRIES, HiveConf.ConfVars.METASTORE_CLIENT_CONNECT_RETRY_DELAY,
            HiveConf.ConfVars.METASTORE_CLIENT_SOCKET_TIMEOUT, HiveConf.ConfVars.METASTORE_CLIENT_SOCKET_LIFETIME, HiveConf.ConfVars.METASTOREPWD,
            HiveConf.ConfVars.METASTORECONNECTURLHOOK, HiveConf.ConfVars.METASTORECONNECTURLKEY, HiveConf.ConfVars.METASTORESERVERMINTHREADS,
            HiveConf.ConfVars.METASTORESERVERMAXTHREADS, HiveConf.ConfVars.METASTORE_TCP_KEEP_ALIVE, HiveConf.ConfVars.METASTORE_INT_ORIGINAL,
            HiveConf.ConfVars.METASTORE_INT_ARCHIVED, HiveConf.ConfVars.METASTORE_INT_EXTRACTED, HiveConf.ConfVars.METASTORE_KERBEROS_KEYTAB_FILE,
            HiveConf.ConfVars.METASTORE_KERBEROS_PRINCIPAL, HiveConf.ConfVars.METASTORE_USE_THRIFT_SASL, HiveConf.ConfVars.METASTORE_TOKEN_SIGNATURE
            , HiveConf.ConfVars.METASTORE_CACHE_PINOBJTYPES, HiveConf.ConfVars.METASTORE_CONNECTION_POOLING_TYPE,
            HiveConf.ConfVars.METASTORE_VALIDATE_TABLES, HiveConf.ConfVars.METASTORE_DATANUCLEUS_INIT_COL_INFO,
            HiveConf.ConfVars.METASTORE_VALIDATE_COLUMNS, HiveConf.ConfVars.METASTORE_VALIDATE_CONSTRAINTS,
            HiveConf.ConfVars.METASTORE_STORE_MANAGER_TYPE, HiveConf.ConfVars.METASTORE_AUTO_CREATE_ALL,
            HiveConf.ConfVars.METASTORE_TRANSACTION_ISOLATION, HiveConf.ConfVars.METASTORE_CACHE_LEVEL2,
            HiveConf.ConfVars.METASTORE_CACHE_LEVEL2_TYPE, HiveConf.ConfVars.METASTORE_IDENTIFIER_FACTORY,
            HiveConf.ConfVars.METASTORE_PLUGIN_REGISTRY_BUNDLE_CHECK, HiveConf.ConfVars.METASTORE_AUTHORIZATION_STORAGE_AUTH_CHECKS,
            HiveConf.ConfVars.METASTORE_BATCH_RETRIEVE_MAX, HiveConf.ConfVars.METASTORE_EVENT_LISTENERS,
            HiveConf.ConfVars.METASTORE_TRANSACTIONAL_EVENT_LISTENERS, HiveConf.ConfVars.METASTORE_EVENT_CLEAN_FREQ,
            HiveConf.ConfVars.METASTORE_EVENT_EXPIRY_DURATION, HiveConf.ConfVars.METASTORE_EVENT_MESSAGE_FACTORY,
            HiveConf.ConfVars.METASTORE_FILTER_HOOK, HiveConf.ConfVars.METASTORE_RAW_STORE_IMPL,
            HiveConf.ConfVars.METASTORE_END_FUNCTION_LISTENERS, HiveConf.ConfVars.METASTORE_PART_INHERIT_TBL_PROPS,
            HiveConf.ConfVars.METASTORE_BATCH_RETRIEVE_OBJECTS_MAX, HiveConf.ConfVars.METASTORE_INIT_HOOKS,
            ...
            , HiveConf.ConfVars.HMSHANDLERFORCERELOADCONF, HiveConf.ConfVars.METASTORE_PARTITION_NAME_WHITELIST_PATTERN,
            HiveConf.ConfVars.METASTORE_ORM_RETRIEVE_MAPNULLS_AS_EMPTY_STRINGS,
            HiveConf.ConfVars.METASTORE_DISALLOW_INCOMPATIBLE_COL_TYPE_CHANGES, HiveConf.ConfVars.USERS_IN_ADMIN_ROLE,
            HiveConf.ConfVars.HIVE_AUTHORIZATION_MANAGER, HiveConf.ConfVars.HIVE_TXN_MANAGER, HiveConf.ConfVars.HIVE_TXN_TIMEOUT,
            HiveConf.ConfVars.HIVE_TXN_OPERATIONAL_PROPERTIES, HiveConf.ConfVars.HIVE_TXN_HEARTBEAT_THREADPOOL_SIZE,
            HiveConf.ConfVars.HIVE_TXN_MAX_OPEN_BATCH, HiveConf.ConfVars.HIVE_TXN_RETRYABLE_SQLEX_REGEX,
            HiveConf.ConfVars.HIVE_METASTORE_STATS_NDV_TUNER, HiveConf.ConfVars.HIVE_METASTORE_STATS_NDV_DENSITY_FUNCTION,
            HiveConf.ConfVars.METASTORE_AGGREGATE_STATS_CACHE_ENABLED, HiveConf.ConfVars.METASTORE_AGGREGATE_STATS_CACHE_SIZE,
            ...
            HiveConf.ConfVars.METASTORE_AGGREGATE_STATS_CACHE_CLEAN_UNTIL, HiveConf.ConfVars.METASTORE_FASTPATH,
     ...
     */
    public static final HiveConf.ConfVars[] metaConfVars = {HiveConf.ConfVars.METASTORE_TRY_DIRECT_SQL,
            HiveConf.ConfVars.METASTORE_TRY_DIRECT_SQL_DDL, HiveConf.ConfVars.METASTORE_CLIENT_SOCKET_TIMEOUT,
     ...
     */
    public static final HiveConf.ConfVars[] dbVars = {HiveConf.ConfVars.HADOOPBIN, HiveConf.ConfVars.METASTOREWAREHOUSE,
    ...
    public static enum ConfVars {
        ...
        LOCALSCRATCHDIR("hive.exec.local.scratchdir", "${system:java.io.tmpdir}" + File.separator + "${system:user.name}",
                "Local scratch space " + "for" + " Hive jobs"),
        DOWNLOADED_RESOURCES_DIR("hive.downloaded.resources.dir", "${system:java.io.tmpdir}" + File.separator + "${hive.session.id}_resources",
        ...
        SUBMITLOCALTASKVIACHILD("hive.exec.submit.local.task.via.child", true, "Determines whether local tasks (typically mapjoin hashtable " +
                "generation phase) runs in \n" + "separate JVM (true recommended) or not. \n" + "Avoids the overhead of spawning new JVM, but can lead to " + "out-of-memory issues."),
        SCRIPTERRORLIMIT("hive.exec.script.maxerrsize", 100000, "Maximum number of bytes a script is allowed to emit to standard error (per " +
                "map" + "-reduce task). \n" + "This prevents runaway scripts from filling logs partitions to capacity"),
        ALLOWPARTIALCONSUMP("hive.exec.script.allow.partial.consumption", false, "When enabled, this option allows a user script to exit " +
                "successfully without consuming \n" + "all the data from the standard input."),
        STREAMREPORTERPERFIX("stream.stderr.reporter.prefix", "reporter:", "Streaming jobs that log to standard error with this prefix can log " +
                "counter or status information."),
        ...
        COMPRESSRESULT("hive.exec.compress.output", false, "This controls whether the final outputs of a query (to a local/HDFS file or a Hive " +
                "table) is compressed. \n" + "The compression codec and other options are determined from Hadoop config variables mapred.output.compress*"),
        COMPRESSINTERMEDIATE("hive.exec.compress.intermediate", false, "This controls whether intermediate files produced by Hive between multiple "
                + "map-reduce jobs are compressed. \n" + "The compression codec and other options are determined from Hadoop config variables mapred" +
                ".output" + ".compress*"),
        COMPRESSINTERMEDIATECODEC("hive.intermediate.compression.codec", "", ""),
        COMPRESSINTERMEDIATETYPE("hive.intermediate.compression.type", "", ""),
        BYTESPERREDUCER("hive.exec.reducers.bytes.per.reducer", (long) (256 * 1000 * 1000), "size per reducer.The default is 256Mb, i.e if the " +
                "input size is 1G, it will use 4 reducers."),
        MAXREDUCERS("hive.exec.reducers.max", 1009, "max number of reducers will be used. If the one specified in the configuration parameter " +
                "mapred.reduce.tasks is\n" + "negative, Hive will use this one as the max number of reducers when automatically determine number of " +
                "reducers."),
        ...
        POSTEXECHOOKS("hive.exec.post.hooks", "", "Comma-separated list of post-execution hooks to be invoked for each statement. \n" + "A " +
                "post" + "-execution hook is specified as the name of a Java class which implements the \n" + "org.apache.hadoop.hive.ql.hooks" +
        ...
        ONFAILUREHOOKS("hive.exec.failure.hooks", "", "Comma-separated list of on-failure hooks to be invoked for each statement. \n" + "An " + "on"
                + "-failure hook is specified as the name of Java class which implements the \n" + "org.apache.hadoop.hive.ql.hooks" +
                ".ExecuteWithHookContext" + " " + "interface."),
        ...
        CLIENTSTATSPUBLISHERS("hive.client.stats.publishers", "", "Comma-separated list of statistics publishers to be invoked on counters on each "
                + "job. \n" + "A client stats publisher is specified as the name of a Java class which implements the \n" + "org.apache.hadoop.hive.ql" +
                ".stats" + ".ClientStatsPublisher interface."),
        ...
        DYNAMICPARTITIONINGMODE("hive.exec.dynamic.partition.mode", "strict", "In strict mode, the user must specify at least one static " +
        ...
        DYNAMICPARTITIONMAXPARTSPERNODE("hive.exec.max.dynamic.partitions.pernode", 100, "Maximum number of dynamic partitions allowed to be " +
        ...
        DEFAULTPARTITIONNAME("hive.exec.default.partition.name", "__HIVE_DEFAULT_PARTITION__", "The default partition name in case the dynamic " +
                "partition column value is null/empty string or any other values that cannot be escaped. \n" + "This value must not contain any special " + "character used in HDFS URI (e.g., ':', '%', '/' etc). \n" + "The user has to be aware that the dynamic partition value should not " + "contain" + " this value to avoid confusions."),
        ...
        SHOW_JOB_FAIL_DEBUG_INFO("hive.exec.show.job.failure.debug.info", true,
                "If a job fails, whether to provide a link in the CLI to the task " + "with the\n" + "most failures, along with debugging hints if " +
                        "applicable."),
        JOB_DEBUG_CAPTURE_STACKTRACES("hive.exec.job.debug.capture.stacktraces", true, "Whether or not stack traces parsed from the task logs of a "
        ...
        LOCALMODEMAXBYTES("hive.exec.mode.local.auto.inputbytes.max", 134217728L, "When hive.exec.mode.local.auto is true, input bytes should less "
                + "than this for local mode."),
        LOCALMODEMAXINPUTFILES("hive.exec.mode.local.auto.input.files.max", 4, "When hive.exec.mode.local.auto is true, the number of tasks should "
                + "less than this for local mode."),
        
        DROPIGNORESNONEXISTENT("hive.exec.drop.ignorenonexistent", true, "Do not report an error if DROP TABLE/VIEW/Index/Function specifies a " +
        ...
        METASTORE_FASTPATH("hive.metastore.fastpath", false,
                "Used to avoid all of the proxies and object copies in the metastore.  Note, if this " + "is " + "set, you MUST use a local metastore " +
                        "(hive.metastore.uris must be empty) otherwise " + "undefined and most likely undesired " + "behavior will result"),
        METASTORE_FS_HANDLER_THREADS_COUNT("hive.metastore.fshandler.threads", 15, "Number of threads to be allocated for metastore handler for fs "
                + "operations."),
        ...
        METASTORE_HBASE_AGGREGATE_STATS_CACHE_MAX_PARTITIONS("hive.metastore.hbase.aggregate.stats.max.partitions", 10000, "Maximum number of " +
                "partitions that are aggregated per cache node."),
        ...
        METASTORE_HBASE_CACHE_TIME_TO_LIVE("hive.metastore.hbase.cache.ttl", "600s", new TimeValidator(TimeUnit.SECONDS), "Number of seconds for a "
                + "cached node to be active in the cache before they become stale."),
        ...
        METASTORE_HBASE_CACHE_MAX_FULL("hive.metastore.hbase.cache.max.full", (float) 0.9, "Maximum cache full % after which the cache cleaner " +
                "thread kicks in."),
        ...
        METASTORE_HBASE_CONNECTION_CLASS("hive.metastore.hbase.connection.class", "org.apache.hadoop.hive.metastore.hbase.VanillaHBaseConnection",
                "Class used to connection to HBase"),
        METASTORE_HBASE_AGGR_STATS_CACHE_ENTRIES("hive.metastore.hbase.aggr.stats.cache.entries", 10000,
                "How many in stats objects to cache in " + "memory"),
        METASTORE_HBASE_AGGR_STATS_MEMORY_TTL("hive.metastore.hbase.aggr.stats.memory.ttl", "60s", new TimeValidator(TimeUnit.SECONDS), "Number of "
                + "seconds stats objects live in memory after they are read from HBase."),
        METASTORE_HBASE_AGGR_STATS_INVALIDATOR_FREQUENCY("hive.metastore.hbase.aggr.stats.invalidator.frequency", "5s",
                new TimeValidator(TimeUnit.SECONDS), "How often the stats cache scans its HBase entries and looks for expired entries"),
        METASTORE_HBASE_AGGR_STATS_HBASE_TTL("hive.metastore.hbase.aggr.stats.hbase.ttl", "604800s", new TimeValidator(TimeUnit.SECONDS),
                "Number " + "of seconds stats entries live in HBase cache after they are created.  They may be" + " invalided by updates or partition " +
                        "drops before " + "this.  Default is one week."),
        ...
        METASTORE_CLIENT_SOCKET_TIMEOUT("hive.metastore.client.socket.timeout", "600s", new TimeValidator(TimeUnit.SECONDS), "MetaStore Client " +
                "socket timeout in seconds"),
        METASTORE_CLIENT_SOCKET_LIFETIME("hive.metastore.client.socket.lifetime", "0s", new TimeValidator(TimeUnit.SECONDS), "MetaStore Client " +
                "socket lifetime in seconds. After this time is exceeded, client\n" + "reconnects on the next MetaStore operation. A value of 0s means the" + " connection\n" + "has an infinite lifetime."),
        ...
        METASTOREMULTITHREADED("javax.jdo.option.Multithreaded", true, "Set this to true if multiple threads access metastore through JDO " +
                "concurrently."),
        ...
        METASTORE_DBACCESS_SSL_PROPS("hive.metastore.dbaccess.ssl.properties", "", "Comma-separated SSL properties for metastore to access " +
                "database" + " when JDO connection URL\n" + "enables SSL access. e.g. javax.net.ssl.trustStore=/tmp/truststore,javax.net.ssl" +
        ...
        HMSHANDLERINTERVAL("hive.hmshandler.retry.interval", "2000ms", new TimeValidator(TimeUnit.MILLISECONDS), "The time between HMSHandler " +
                "retry" + " attempts on failure."),
        HMSHANDLERFORCERELOADCONF("hive.hmshandler.force.reload.conf", false, "Whether to force reloading of the HMSHandler configuration " +
                "(including\n" + "the connection URL, before the next metastore query that accesses the\n" + "datastore. Once reloaded, this value is " +
                "reset to false. Used for\n" + "testing only."),
        METASTORESERVERMAXMESSAGESIZE("hive.metastore.server.max.message.size", 100 * 1024 * 1024L, "Maximum message size in bytes a HMS will " +
                "accept."),
        ...
        METASTORE_TCP_KEEP_ALIVE("hive.metastore.server.tcp.keepalive", true, "Whether to enable TCP keepalive for the metastore server. Keepalive "
                + "will prevent accumulation of half-open connections."),
        
        METASTORE_INT_ORIGINAL("hive.metastore.archive.intermediate.original", "_INTERMEDIATE_ORIGINAL", "Intermediate dir suffixes used for " +
                "archiving. Not important what they\n" + "are, as long as collisions are avoided"),
        ...
        METASTORE_KERBEROS_PRINCIPAL("hive.metastore.kerberos.principal", "hive-metastore/_HOST@EXAMPLE.COM", "The service principal for the " +
                "metastore Thrift server. \n" + "The special string _HOST will be replaced automatically with the correct host name."),
        METASTORE_USE_THRIFT_SASL("hive.metastore.sasl.enabled", false, "If true, the metastore Thrift interface will be secured with SASL. " +
        ...
        METASTORE_USE_THRIFT_COMPACT_PROTOCOL("hive.metastore.thrift.compact.protocol.enabled", false,
                "If true, the metastore Thrift interface " + "will use TCompactProtocol. When false (default) TBinaryProtocol will be used.\n" + "Setting "
                        + "it to true will break compatibility with " + "older clients running TBinaryProtocol."),
        ...
        METASTORE_CLUSTER_DELEGATION_TOKEN_STORE_ZK_CONNECTSTR("hive.cluster.delegation.token.store.zookeeper.connectString", "",
                "The ZooKeeper " + "token store connect string. You can re-use the configuration value\n" + "set in hive.zookeeper.quorum, by leaving " +
                        "this" + " parameter unset."),
        METASTORE_CLUSTER_DELEGATION_TOKEN_STORE_ZK_ZNODE("hive.cluster.delegation.token.store.zookeeper.znode", "/hivedelegation", "The root path "
                + "for token store data. Note that this is used by both HiveServer2 and\n" + "MetaStore to store delegation Token. One directory gets " +
                "created for each of them.\n" + "The final directory names would have the servername appended to it (HIVESERVER2,\n" + "METASTORE)."),
        METASTORE_CLUSTER_DELEGATION_TOKEN_STORE_ZK_ACL("hive.cluster.delegation.token.store.zookeeper.acl", "", "ACL for token store entries. " +
                "Comma separated list of ACL entries. For example:\n" + "sasl:hive/host1@MY.DOMAIN:cdrwa,sasl:hive/host2@MY.DOMAIN:cdrwa\n" + "Defaults to" + " all permissions for the hiveserver2/metastore process user."),
        METASTORE_CACHE_PINOBJTYPES("hive.metastore.cache.pinobjtypes", "Table,StorageDescriptor,SerDeInfo,Partition,Database,Type,FieldSchema," +
                "Order", "List of comma separated metastore object types that should be pinned in the cache"),
        METASTORE_CONNECTION_POOLING_TYPE("datanucleus.connectionPoolingType", "BONECP", new StringSet("BONECP", "DBCP", "HikariCP", "NONE"),
        ...
        METASTORE_VALIDATE_TABLES("datanucleus.schema.validateTables", false, "validates existing schema against code. turn this on if you want to "
        ...
        METASTORE_AUTO_CREATE_ALL("datanucleus.schema.autoCreateAll", false, "Auto creates necessary schema on a startup if one doesn't exist. Set "
                + "this to false, after creating it once." + "To enable auto create also set hive.metastore.schema.verification=false. Auto creation is " + "not " + "recommended for production use cases, run schematool command instead."),
        METASTORE_SCHEMA_VERIFICATION("hive.metastore.schema.verification", true, "Enforce metastore schema version consistency.\n" + "True: " +
                "Verify" + " that version information stored in is compatible with one from Hive jars.  Also disable automatic\n" + "      schema " +
                "migration attempt. " + "Users are required to manually migrate schema after Hive upgrade which ensures\n" + "      proper metastore " +
                "schema migration. (Default)" + "\n" + "False: Warn if the version information stored in metastore doesn't match with one from in Hive " +
                "jars."),
        METASTORE_SCHEMA_VERIFICATION_RECORD_VERSION("hive.metastore.schema.verification.record.version", false, "When true the current MS version "
                + "is recorded in the VERSION table. If this is disabled and verification is\n" + " enabled the MS will be unusable."),
        METASTORE_TRANSACTION_ISOLATION("datanucleus.transactionIsolation", "read-committed",
                "Default transaction isolation level for identity " + "generation."),
        METASTORE_CACHE_LEVEL2("datanucleus.cache.level2", false, "Use a level 2 cache. Turn this off if metadata is changed independently of Hive "
                + "metastore server"),
        METASTORE_CACHE_LEVEL2_TYPE("datanucleus.cache.level2.type", "none", ""),
        METASTORE_IDENTIFIER_FACTORY("datanucleus.identifierFactory", "datanucleus1", "Name of the identifier factory to use when generating " +
        ...
        METASTORE_BATCH_RETRIEVE_MAX("hive.metastore.batch.retrieve.max", 300, "Maximum number of objects (tables/partitions) can be retrieved " +
                "from" + " metastore in one batch. \n" + "The higher the number, the less the number of round trips is needed to the Hive metastore " +
                "server, \n" + "but " + "it may also cause higher memory requirement at the client side."),
        METASTORE_BATCH_RETRIEVE_OBJECTS_MAX("hive.metastore.batch.retrieve.table.partition.max", 1000,
                "Maximum number of objects that metastore " + "internally retrieves in one batch."),
        
        METASTORE_INIT_HOOKS("hive.metastore.init.hooks", "", "A comma separated list of hooks to be invoked at the beginning of HMSHandler " +
                "initialization. \n" + "An init hook is specified as the name of Java class which extends org.apache.hadoop.hive.metastore" +
        ...
        METASTORE_EVENT_LISTENERS("hive.metastore.event.listeners", "", "A comma separated list of Java classes that implement the org.apache" +
                ".hadoop.hive.metastore.MetaStoreEventListener" + " interface. The metastore event and corresponding listener method will be invoked in " + "separate JDO transactions. " + "Alternatively, configure hive.metastore.transactional.event.listeners to ensure both are invoked in same" + " " + "JDO transaction."),
        ...
        METASTORE_EVENT_DB_LISTENER_TTL("hive.metastore.event.db.listener.timetolive", "86400s", new TimeValidator(TimeUnit.SECONDS),
        ...
        METASTORE_EVENT_MESSAGE_FACTORY("hive.metastore.event.message.factory", "org.apache.hadoop.hive.metastore.messaging.json" +
                ".JSONMessageFactory", "Factory class for making encoding and decoding messages in the events generated."),
        METASTORE_EXECUTE_SET_UGI("hive.metastore.execute.setugi", true, "In unsecure mode, setting this property to true will cause the metastore "
                + "to execute DFS operations using \n" + "the client's reported user and group permissions. Note that this property must be set on \n" +
                "both " + "the client and server sides. Further note that its best effort. \n" + "If client sets its to true and server sets it to false, "
                + "client " + "setting will be ignored."),
        METASTORE_PARTITION_NAME_WHITELIST_PATTERN("hive.metastore.partition.name.whitelist.pattern", "", "Partition names will be checked against "
                + "this regex pattern and rejected if not matched."),
        
        METASTORE_INTEGER_JDO_PUSHDOWN("hive.metastore.integral.jdo.pushdown", false,
                "Allow JDO query pushdown for integral partition columns in " + "metastore. Off by default. This\n" + "improves metastore perf for " +
                        "integral columns, especially if there's a large number of partitions" + ".\n" + "However, it doesn't work correctly with integral values" + " that are not normalized (e.g. have\n" + "leading zeroes, like 0012). If " + "metastore direct SQL is enabled and works, this " + "optimization\n" + "is also irrelevant."),
        METASTORE_TRY_DIRECT_SQL("hive.metastore.try.direct.sql", true,
                "Whether the Hive metastore should try to use direct SQL queries instead " + "of" + " the\n" + "DataNucleus for certain read paths. This " +
                        "can improve metastore performance when\n" + "fetching many partitions or " + "column " + "statistics by orders of magnitude; however, " +
                        "it\n" + "is not guaranteed to work on all RDBMS-es and all versions. In case of " + "SQL " + "failures," + "\n" + "the metastore will " +
                        "fall back to the DataNucleus, so it's safe even if SQL doesn't\n" + "work for all " + "queries on your " + "datastore. " + "If all SQL" +
                        " queries fail (for example, your\n" + "metastore is backed by MongoDB), you might want " + "to disable this to save " + "the\n" +
                        "try" + "-and-fall-back cost."),
        METASTORE_DIRECT_SQL_PARTITION_BATCH_SIZE("hive.metastore.direct.sql.batch.size", 0,
                "Batch size for partition and other object retrieval " + "from the underlying DB in direct\n" + "SQL. For some DBs like Oracle and MSSQL, "
                        + "there are hardcoded or perf-based limitations\n" + "that " + "necessitate this. For DBs that can handle the queries, this isn't " +
                        "necessary and\n" + "may impede performance. -1 means no batching, 0 " + "means automatic batching."),
        METASTORE_TRY_DIRECT_SQL_DDL("hive.metastore.try.direct.sql.ddl", true, "Same as hive.metastore.try.direct.sql, for read statements within "
                + "a transaction that\n" + "modifies metastore data. Due to non-standard behavior in Postgres, if a direct SQL\n" + "select query has " +
                "incorrect syntax or something similar inside a transaction, the\n" + "entire transaction will fail and fall-back to DataNucleus will not" + " " + "be possible. You\n" + "should disable the usage of direct SQL inside transactions if that happens in your case."),
        ...
        METASTORE_DIRECT_SQL_MAX_ELEMENTS_VALUES_CLAUSE("hive.direct.sql.max.elements.values.clause", 1000, "The maximum number of values in a " +
                "VALUES clause for INSERT statement."),
        METASTORE_ORM_RETRIEVE_MAPNULLS_AS_EMPTY_STRINGS("hive.metastore.orm.retrieveMapNullsAsEmptyStrings", false, "Thrift does not support " +
                "nulls" + " in maps, so any nulls present in maps retrieved from ORM must " + "either be pruned or converted to empty strings. Some " +
                "backing dbs such" + " as Oracle persist empty strings " + "as nulls, so we should set this parameter if we wish to reverse that " +
                "behaviour. For others, " + "pruning" + " is the correct behaviour"),
        METASTORE_DISALLOW_INCOMPATIBLE_COL_TYPE_CHANGES("hive.metastore.disallow.incompatible.col.type.changes", true, "If true (default is false)"
                + ", ALTER TABLE operations which change the type of a\n" + "column (say STRING) to an incompatible type (say MAP) are disallowed.\n" +
                "RCFile " + "default SerDe (ColumnarSerDe) serializes the values in such a way that the\n" + "datatypes can be converted from string to " + "any " + "type. The" + " map is also serialized as\n" + "a string, which can be read as a string as well. However, with any binary\n" + "serialization," + " this is" + " not true. Blocking the ALTER TABLE prevents ClassCastExceptions\n" + "when subsequently trying to " + "access old partitions.\n" + "\n" + "Primitive types like INT, STRING, BIGINT, etc., are compatible with each other and are\n" + "not " + "blocked.\n" + "\n" + "See " + "HIVE-4409 " + "for more details."),
        METASTORE_LIMIT_PARTITION_REQUEST("hive.metastore.limit.partition.request", -1, "This limits the number of partitions that can be " +
                "requested" + " from the metastore for a given table.\n" + "The default value \"-1\" means no limit."),
        ...
        METASTORE_RAW_STORE_IMPL("hive.metastore.rawstore.impl", "org.apache.hadoop.hive.metastore.ObjectStore", "Name of the class that " +
                "implements" + " org.apache.hadoop.hive.metastore.rawstore interface. \n" + "This class is used to store and retrieval of raw metadata " +
                "objects such as " + "table, database"),
        METASTORE_TXN_STORE_IMPL("hive.metastore.txn.store.impl", "org.apache.hadoop.hive.metastore.txn.CompactionTxnHandler", "Name of class that "
                + "implements org.apache.hadoop.hive.metastore.txn.TxnStore.  This " + "class is used to store and retrieve transactions and locks"),
        METASTORE_CONNECTION_DRIVER("javax.jdo.option.ConnectionDriverName", "org.apache.derby.jdbc.EmbeddedDriver", "Driver class name for a JDBC "
                + "metastore"),
        METASTORE_MANAGER_FACTORY_CLASS("javax.jdo.PersistenceManagerFactoryClass", "org.datanucleus.api.jdo.JDOPersistenceManagerFactory", "class "
                + "implementing the jdo persistence"),
        METASTORE_EXPRESSION_PROXY_CLASS("hive.metastore.expression.proxy", "org.apache.hadoop.hive.ql.optimizer.ppr" +
                ".PartitionExpressionForMetastore", ""),
        METASTORE_DETACH_ALL_ON_COMMIT("javax.jdo.option.DetachAllOnCommit", true, "Detaches all objects from session so that they can be used " +
        ...
        METASTORE_PART_INHERIT_TBL_PROPS("hive.metastore.partition.inherit.table.properties", "", "List of comma separated keys occurring in table "
                + "properties which will get inherited to newly created partitions. \n" + "* implies all the keys will get inherited."),
        METASTORE_FILTER_HOOK("hive.metastore.filter.hook", "org.apache.hadoop.hive.metastore.DefaultMetaStoreFilterHookImpl", "Metastore hook " +
                "class for filtering the metadata read results. If hive.security.authorization.manager" + "is set to instance of HiveAuthorizerFactory, " + "then this value is ignored."),
        ...
        METASTORE_CLIENT_DROP_PARTITIONS_WITH_EXPRESSIONS("hive.metastore.client.drop.partitions.using.expressions", true, "Choose whether " +
                "dropping" + " partitions with HCatClient pushes the partition-predicate to the metastore, " + "or drops partitions iteratively"),
        ...
        METASTORE_AGGREGATE_STATS_CACHE_MAX_PARTITIONS("hive.metastore.aggregate.stats.cache.max.partitions", 10000, "Maximum number of partitions "
                + "that are aggregated per cache node."),
        ...
        METASTORE_AGGREGATE_STATS_CACHE_MAX_VARIANCE("hive.metastore.aggregate.stats.cache.max.variance", (float) 0.01, "Maximum tolerable " +
                "variance" + " in number of partitions between a cached node and our request (default 1%)."),
        ...
        METASTORE_AGGREGATE_STATS_CACHE_MAX_WRITER_WAIT("hive.metastore.aggregate.stats.cache.max.writer.wait", "5000ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Number of milliseconds a writer will wait to acquire the writelock before giving up."),
        METASTORE_AGGREGATE_STATS_CACHE_MAX_READER_WAIT("hive.metastore.aggregate.stats.cache.max.reader.wait", "1000ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Number of milliseconds a reader will wait to acquire the readlock before giving up."),
        ...
        METASTORE_INIT_METADATA_COUNT_ENABLED("hive.metastore.initial.metadata.count.enabled", true, "Enable a metadata count at metastore startup "
                + "for metrics."),
        ...
        METADATA_EXPORT_LOCATION("hive.metadata.export.location", "", "When used in conjunction with the org.apache.hadoop.hive.ql.parse" +
                ".MetaDataExportListener pre event listener, \n" + "it is the location to which the metadata will be exported. The default is an empty " +
                "string, which results in the \n" + "metadata being exported to the current user's home directory on HDFS."),
        MOVE_EXPORTED_METADATA_TO_TRASH("hive.metadata.move.exported.metadata.to.trash", true, "When used in conjunction with the org.apache" +
                ".hadoop" + ".hive.ql.parse.MetaDataExportListener pre event listener, \n" + "this setting determines if the metadata that is exported " +
                "will " + "subsequently be moved to the user's trash directory \n" + "alongside the dropped table data. This ensures that the metadata " +
                "will be " + "cleaned up along with the dropped table data."),
        ...
        CLIPRETTYOUTPUTNUMCOLS("hive.cli.pretty.output.num.cols", -1, "The number of columns to use when formatting output generated by the " +
                "DESCRIBE PRETTY table_name command.\n" + "If the value of this property is -1, then Hive will use the auto-detected terminal width."),
        ...
        // reloadable jars
        HIVERELOADABLEJARS("hive.reloadable.aux.jars.path", "", "The locations of the plugin jars, which can be a comma-separated folders or jars. "
                + "Jars can be renewed\n" + "by executing reload command. And these jars can be " + "used as the auxiliary classes like creating a UDF or "
                + "SerDe."),
        ...
        HIVESCRIPTAUTOPROGRESS("hive.script.auto.progress", false,
                "Whether Hive Transform/Map/Reduce Clause should automatically send progress " + "information to TaskTracker \n" + "to avoid the task " +
                        "getting killed because of inactivity.  Hive sends progress information when the " + "script is \n" + "outputting to stderr.  This option" + " removes the need of periodically producing stderr messages, \n" + "but users should " + "be cautious because this may prevent infinite" + " loops in the scripts to be killed by TaskTracker."),
        HIVESCRIPTIDENVVAR("hive.script.operator.id.env.var", "HIVE_SCRIPT_OPERATOR_ID",
                "Name of the environment variable that holds the unique " + "script operator ID in the user's \n" + "transform function (the custom " +
                        "mapper/reducer that the user has specified in the query)"),
        HIVESCRIPTTRUNCATEENV("hive.script.operator.truncate.env", false, "Truncate each environment variable for external script in scripts " +
                "operator to 20KB (to fit system limits)"),
        HIVESCRIPT_ENV_BLACKLIST("hive.script.operator.env.blacklist", "hive.txn.valid.txns,hive.script.operator.env.blacklist",
                "Comma separated " + "list of keys from the configuration file not to convert to environment " + "variables when envoking the script " +
                        "operator"),
        ...
        HIVE_STRICT_CHECKS_CARTESIAN("hive.strict.checks.cartesian.product", true, "Enabling strict Cartesian join checks disallows the " +
        ...
        @Deprecated HIVEMAPREDMODE("hive.mapred.mode", null, "Deprecated; use hive.strict.checks.* settings instead."),
        ...
        HIVEJOINEMITINTERVAL("hive.join.emit.interval", 1000, "How many rows in the right-most join operand Hive should buffer before emitting the "
                + "join result."),
        HIVEJOINCACHESIZE("hive.join.cache.size", 25000, "How many rows in the joining tables (except the streaming table) should be cached in " +
                "memory."),
        
        // CBO related
        HIVE_CBO_ENABLED("hive.cbo.enable", true, "Flag to control enabling Cost Based Optimizations using Calcite framework."),
        HIVE_CBO_CNF_NODES_LIMIT("hive.cbo.cnf.maxnodes", -1, "When converting to conjunctive normal form (CNF), fail if" + "the expression " +
                "exceeds" + " this threshold; the threshold is expressed in terms of number of nodes (leaves and" + "interior nodes). -1 to not set up a " + "threshold."),
        HIVE_CBO_RETPATH_HIVEOP("hive.cbo.returnpath.hiveop", false, "Flag to control calcite plan to hive operator conversion"),
        HIVE_CBO_EXTENDED_COST_MODEL("hive.cbo.costmodel.extended", false,
                "Flag to control enabling the extended cost model based on" + "CPU, IO " + "and cardinality. Otherwise, the cost model is based on " +
                        "cardinality."),
        HIVE_CBO_COST_MODEL_CPU("hive.cbo.costmodel.cpu", "0.000001", "Default cost of a comparison"),
        HIVE_CBO_COST_MODEL_NET("hive.cbo.costmodel.network", "150.0", "Default cost of a transfering a byte over network;" + " expressed as " +
                "multiple of CPU cost"),
        HIVE_CBO_COST_MODEL_LFS_WRITE("hive.cbo.costmodel.local.fs.write", "4.0",
                "Default cost of writing a byte to local FS;" + " expressed as " + "multiple of NETWORK cost"),
        HIVE_CBO_COST_MODEL_LFS_READ("hive.cbo.costmodel.local.fs.read", "4.0",
                "Default cost of reading a byte from local FS;" + " expressed as " + "multiple of NETWORK cost"),
        HIVE_CBO_COST_MODEL_HDFS_WRITE("hive.cbo.costmodel.hdfs.write", "10.0", "Default cost of writing a byte to HDFS;" + " expressed as " +
                "multiple" + " of Local FS write cost"),
        HIVE_CBO_COST_MODEL_HDFS_READ("hive.cbo.costmodel.hdfs.read", "1.5", "Default cost of reading a byte from HDFS;" + " expressed as multiple "
                + "of Local FS read cost"),
        ...
        HIVE_COLUMN_ALIGNMENT("hive.order.columnalignment", true,
                "Flag to control whether we want to try to align" + "columns in operators such " + "as" + " Aggregate or Join so that we try to reduce the" +
                        " number of shuffling stages"),
        
        // materialized views
        HIVE_MATERIALIZED_VIEW_ENABLE_AUTO_REWRITING("hive.materializedview.rewriting", false, "Whether to try to rewrite queries using the " +
                "materialized views enabled for rewriting"),
        HIVE_MATERIALIZED_VIEW_FILE_FORMAT("hive.materializedview.fileformat", "ORC", new StringSet("none", "TextFile", "SequenceFile", "RCfile",
                "ORC"), "Default file format for CREATE MATERIALIZED VIEW statement"),
        HIVE_MATERIALIZED_VIEW_SERDE("hive.materializedview.serde", "org.apache.hadoop.hive.ql.io.orc.OrcSerde", "Default SerDe used for " +
                "materialized views"),
        ...
        HIVEMAPJOINOPTIMIZEDTABLEPROBEPERCENT("hive.mapjoin.optimized.hashtable.probe.percent", (float) 0.5, "Probing space percentage of the " +
                "optimized hashtable"),
        HIVEUSEHYBRIDGRACEHASHJOIN("hive.mapjoin.hybridgrace.hashtable", true,
                "Whether to use hybrid" + "grace hash join as the join method for " + "mapjoin. Tez only."),
        HIVEHYBRIDGRACEHASHJOINMEMCHECKFREQ("hive.mapjoin.hybridgrace.memcheckfrequency", 1024,
                "For " + "hybrid grace hash join, how often (how " + "many rows apart) we check if memory is full. " + "This number should be power of 2."),
        HIVEHYBRIDGRACEHASHJOINMINWBSIZE("hive.mapjoin.hybridgrace.minwbsize", 524288,
                "For hybrid grace" + "Hash join, the minimum write buffer " + "size used by optimized hashtable. Default is 512 KB."),
        HIVEHYBRIDGRACEHASHJOINMINNUMPARTITIONS("hive.mapjoin.hybridgrace.minnumpartitions", 16, "For" + "Hybrid grace hash join, the minimum " +
                "number of partitions to create."),
        HIVEHASHTABLEWBSIZE("hive.mapjoin.optimized.hashtable.wbsize", 8 * 1024 * 1024, "Optimized hashtable (see hive.mapjoin.optimized.hashtable)"
                + " uses a chain of buffers to\n" + "store data. This is one buffer size. HT may be slightly faster if this is larger, but for small\n" +
                "joins " + "unnecessary memory will be allocated and then trimmed."),
        HIVEHYBRIDGRACEHASHJOINBLOOMFILTER("hive.mapjoin.hybridgrace.bloomfilter", true, "Whether to " + "use BloomFilter in Hybrid grace hash " +
                "join" + " to minimize unnecessary spilling."),
        ...
        HIVEGROUPBYMAPINTERVAL("hive.groupby.mapaggr.checkinterval", 100000, "Number of rows after which size of the grouping keys/aggregation " +
        ...
        HIVE_GROUPBY_LIMIT_EXTRASTEP("hive.groupby.limit.extrastep", true, "This parameter decides if Hive should \n" + "create new MR job for " +
                "sorting final output"),
        
        // Max file num and size used to do a single copy (after that, distcp is used)
        HIVE_EXEC_COPYFILE_MAXNUMFILES("hive.exec.copyfile.maxnumfiles", 1L, "Maximum number of files Hive uses to do sequential HDFS copies " +
                "between directories." + "Distributed copies (distcp) will be used instead for larger numbers of files so that copies can be done faster."),
        HIVE_EXEC_COPYFILE_MAXSIZE("hive.exec.copyfile.maxsize", 32L * 1024 * 1024 /*32M*/, "Maximum file size (in bytes) that Hive uses to do " +
                "single HDFS copies between directories." + "Distributed copies (distcp) will be used instead for bigger files so that copies can be done " + "faster."),
        ...
        HIVEUDTFAUTOPROGRESS("hive.udtf.auto.progress", false, "Whether Hive should automatically send progress information to TaskTracker \n" +
                ...
                "prevent" + " " + "TaskTracker from killing tasks with infinite loops."),
        ...
        HIVEDEFAULTSERDE("hive.default.serde", "org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe",
        ...
        SERDESUSINGMETASTOREFORSCHEMA("hive.serdes.using.metastore.for.schema",
                "org.apache.hadoop.hive.ql.io.orc.OrcSerde," + "org.apache.hadoop" + ".hive.serde2.lazy.LazySimpleSerDe," + "org.apache.hadoop.hive" +
                        ".serde2" + ".columnar.ColumnarSerDe," + "org.apache.hadoop.hive.serde2" + ".dynamic_type.DynamicSerDe," + "org.apache.hadoop.hive" +
                        ".serde2" + ".MetadataTypedColumnsetSerDe," + "org.apache.hadoop.hive.serde2.columnar" + ".LazyBinaryColumnarSerDe," + "org.apache" +
                        ".hadoop.hive.ql.io" + ".parquet.serde.ParquetHiveSerDe," + "org.apache.hadoop.hive.serde2.lazybinary" + ".LazyBinarySerDe", "SerDes " +
                "retrieving schema from " + "metastore. This is an internal parameter."),
        
        HIVEHISTORYFILELOC("hive.querylog.location", "${system:java.io.tmpdir}" + File.separator + "${system:user.name}",
                "Location of Hive run " + "time structured log file"),
        
        HIVE_LOG_INCREMENTAL_PLAN_PROGRESS("hive.querylog.enable.plan.progress", true, "Whether to log the plan's progress every time a job's " +
        ...
        HIVESCRIPTRECORDREADER("hive.script.recordreader", "org.apache.hadoop.hive.ql.exec.TextRecordReader", "The default record reader for " +
                "reading data from the user scripts. "),
        HIVESCRIPTRECORDWRITER("hive.script.recordwriter", "org.apache.hadoop.hive.ql.exec.TextRecordWriter", "The default record writer for " +
                "writing data to the user scripts. "),
        ...
        HIVE_SCHEMA_EVOLUTION("hive.exec.schema.evolution", true, "Use schema evolution to convert self-describing file format's data to the " +
                "schema" + " desired by the reader."),
        ...
        HIVE_TRANSACTIONAL_NUM_EVENTS_IN_MEMORY("hive.transactional.events.mem", 10000000,
                "Vectorized ACID readers can often load all the delete " + "events from all the delete deltas\n" + "into memory to optimize for " +
                        "performance. To prevent out-of-memory errors, this is a rough " + "heuristic\n" + "that limits the total number of delete events that " + "can be loaded into memory at once.\n" + "Roughly it has been set to " + "10" + " million delete events per bucket (~160 MB).\n"),
        
        HIVESAMPLERANDOMNUM("hive.sample.seednumber", 0, "A number used to percentage sampling. By changing this number, user will change the " +
                "subsets of data sampled."),
        
        // test mode in hive mode
        HIVETESTMODE("hive.test.mode", false, "Whether Hive is running in test mode. If yes, it turns on sampling and prefixes the output " +
                "tablename" + ".", false),
        ...
        HIVETESTMODESAMPLEFREQ("hive.test.mode.samplefreq", 32, "In test mode, specfies sampling frequency for table, which is not bucketed,\n" +
                ...
                + " " + "OVERWRITE TABLE test_dest\n" + "  SELECT col1 from src TABLESAMPLE (BUCKET 1 out of 32 on rand(1))", false),
        HIVETESTMODENOSAMPLE("hive.test.mode.nosamplelist", "", "In test mode, specifies comma separated table names which would not apply " +
                "sampling", false),
        ...
        HIVEMERGEORCFILESTRIPELEVEL("hive.merge.orcfile.stripe.level", true, "When hive.merge.mapfiles, hive.merge.mapredfiles or hive.merge" +
                ".tezfiles is enabled\n" + "while writing a table with ORC file format, enabling this config will do stripe-level\n" + "fast merge for " +
                "small ORC files. Note that enabling this config will not honor the\n" + "padding tolerance config (hive.exec.orc.block.padding" +
                ".tolerance)" + "."),
        ...
        PARQUET_MEMORY_POOL_RATIO("parquet.memory.pool.ratio", 0.5f, "Maximum fraction of heap that can be used by Parquet file writers in one " +
                "task" + ".\n" + "It is for avoiding OutOfMemory error in tasks. Work with Parquet 1.6.0 and above.\n" + "This config parameter is defined" + " in " + "Parquet, so that it does not start with 'hive.'."),
        HIVE_PARQUET_TIMESTAMP_SKIP_CONVERSION("hive.parquet.timestamp.skip.conversion", true, "Current Hive implementation of parquet stores " +
                "timestamps to UTC, this flag allows skipping of the conversion" + "on reading parquet files from other tools"),
        ...
        HIVE_ORC_BASE_DELTA_RATIO("hive.exec.orc.base.delta.ratio", 8,
        ...
        HIVE_ORC_SPLIT_STRATEGY("hive.exec.orc.split.strategy", "HYBRID", new StringSet("HYBRID", "BI", "ETL"),
                "This is not a user level config. " + "BI strategy is used when the requirement is to spend less time in split generation" + " as opposed "
                        + "to query execution (split generation " + "does not read or cache file footers)." + " ETL strategy is used when spending little more " +
                        "time" + " in split generation is acceptable" + " " + "(split generation reads and caches file footers). HYBRID chooses between the " +
                        "above " + "strategies" + " based on heuristics."),
        
        HIVE_ORC_MS_FOOTER_CACHE_ENABLED("hive.orc.splits.ms.footer.cache.enabled", false, "Whether to enable using file metadata cache in " +
                "metastore for ORC file footers."),
        HIVE_ORC_MS_FOOTER_CACHE_PPD("hive.orc.splits.ms.footer.cache.ppd.enabled", true, "Whether to enable file footer cache PPD (hive.orc" +
                ".splits" + ".ms.footer.cache.enabled\n" + "must also be set to true for this to work)."),
        
        HIVE_ORC_INCLUDE_FILE_FOOTER_IN_SPLITS("hive.orc.splits.include.file.footer", false,
                "If turned on splits generated by orc will include " + "metadata about the stripes in the file. This\n" + "data is read remotely (from " +
                        "the" + " client or HS2 machine) and sent to all the tasks."),
        HIVE_ORC_SPLIT_DIRECTORY_BATCH_MS("hive.orc.splits.directory.batch.ms", 0, "How long, in ms, to wait to batch input directories for " +
        ...
        HIVE_ORC_ALLOW_SYNTHETIC_FILE_ID_IN_SPLITS("hive.orc.splits.allow.synthetic.fileid", true, "Allow synthetic file ID in splits on file " +
                "systems that don't have a native one."),
        HIVE_ORC_CACHE_STRIPE_DETAILS_MEMORY_SIZE("hive.orc.cache.stripe.details.mem.size", "256Mb", new SizeValidator(), "Maximum size of orc " +
                "splits cached in the client."),
        HIVE_ORC_COMPUTE_SPLITS_NUM_THREADS("hive.orc.compute.splits.num.threads", 10, "How many threads orc should use to create splits in " +
                "parallel."),
        HIVE_ORC_CACHE_USE_SOFT_REFERENCES("hive.orc.cache.use.soft.references", false, "By default, the cache that ORC input format uses to store "
                + "orc file footer use hard\n" + "references for the cached object. Setting this to true can help avoid out of memory\n" + "issues under " + "memory pressure (in some cases) at the cost of slight unpredictability in\n" + "overall query performance."),
        HIVE_IO_SARG_CACHE_MAX_WEIGHT_MB("hive.io.sarg.cache.max.weight.mb", 10, "The max weight allowed for the SearchArgument Cache. By default, "
                + "the cache allows a max-weight of 10MB, " + "after which entries will be evicted."),
        ...
        HIVELIMITOPTLIMITFILE("hive.limit.optimize.limit.file", 10, "When trying a smaller subset of data for simple LIMIT, maximum number of " +
                "files" + " we can sample."),
        ...
        HIVELIMITOPTMAXFETCH("hive.limit.optimize.fetch.max", 50000, "Maximum number of rows allowed for a smaller subset of data for simple LIMIT,"
                + " if it is a fetch query. \n" + "Insert queries are not restricted by this limit."),
        ...
        @Deprecated HIVELIMITTABLESCANPARTITION("hive.limit.query.max.table.partition", -1,
                "This controls how many partitions can be scanned for " + "each partitioned table.\n" + "The default value \"-1\" means no limit. " +
                        "(DEPRECATED: Please use " + ConfVars.METASTORE_LIMIT_PARTITION_REQUEST + " in the metastore instead.)"),
        
        HIVECONVERTJOINMAXENTRIESHASHTABLE("hive.auto.convert.join.hashtable.max.entries", 40000000L, "If hive.auto.convert.join.noconditionaltask "
                + "is off, this parameter does not take affect. \n" + "However, if it is on, and the predicated number of entries in hashtable for a " +
        ...
        HIVEHASHTABLEKEYCOUNTADJUSTMENT("hive.hashtable.key.count.adjustment", 1.0f,
                "Adjustment to mapjoin hashtable size derived from table and " + "column statistics; the estimate" + " of the number of keys is divided " +
                        "by" + " this value. If the value is 0, statistics are not used" + "and " + "hive.hashtable.initialCapacity is used instead."),
        ...
        HIVEHASHTABLEMAXMEMORYUSAGE("hive.mapjoin.localtask.max.memory.usage", (float) 0.90, "This number means how much memory the local task can "
                + "take to hold the key/value into an in-memory hash table. \n" + "If the local task's memory usage is more than this number, the local " + "task" + " will abort by itself. \n" + "It means the data of the small table is too large to be held in memory."),
        ...
        HIVEINPUTFORMAT("hive.input.format", "org.apache.hadoop.hive.ql.io.CombineHiveInputFormat", "The default input format. Set this to " +
                "HiveInputFormat if you encounter problems with CombineHiveInputFormat."),
        ...
        HIVETEZCONTAINERSIZE("hive.tez.container.size", -1, "By default Tez will spawn containers of the size of a mapper. This can be used to " +
                "overwrite."),
        ...
        HIVE_AUTO_SORTMERGE_JOIN("hive.auto.convert.sortmerge.join", false, "Will the join be automatically converted to a sort-merge join, if the "
                + "joined tables pass the criteria for sort-merge join."),
        HIVE_AUTO_SORTMERGE_JOIN_REDUCE("hive.auto.convert.sortmerge.join.reduce.side", true, "Whether hive.auto.convert.sortmerge.join (if " +
                "enabled) should be applied to reduce side."),
        HIVE_AUTO_SORTMERGE_JOIN_BIGTABLE_SELECTOR("hive.auto.convert.sortmerge.join.bigtable.selection.policy", "org.apache.hadoop.hive.ql" +
                ".optimizer.AvgPartitionSizeBasedBigTableSelectorForAutoSMJ",
                "The policy to choose the big table for automatic conversion to sort-merge " + "join. \n" + "By default, the table with the largest " +
                        "partitions is assigned the big table. All policies are:\n" + ". based on position of" + " " + "the table - the leftmost table is " +
        ...
        HIVEPPDRECOGNIZETRANSITIVITY("hive.ppd.recognizetransivity", true, "Whether to transitively replicate predicate filters over equijoin " +
                "conditions."),
        HIVEPPDREMOVEDUPLICATEFILTERS("hive.ppd.remove.duplicatefilters", true, "During query optimization, filters may be pushed down in the " +
                "operator tree. \n" + "If this config is true only pushed down filters remain in the operator tree, \n" + "and the original filter is " +
                "removed. If this config is false, the original filter \n" + "is also left in the operator tree at the original place."),
        ...
        HIVEMETADATAONLYQUERIES("hive.optimize.metadataonly", false, "Whether to eliminate scans of the tables from which no columns are selected. "
                + "Note\n" + "that, when selecting from empty tables with data files, this can produce incorrect\n" + "results, so it's disabled by " +
        ...
        HIVEOPTIMIZEDISTINCTREWRITE("hive.optimize.distinct.rewrite", true,
        ...
        HIVE_OPTIMIZE_LIMIT_TRANSPOSE("hive.optimize.limittranspose", false,
                "Whether to push a limit through left/right outer join or union. If " + "the value is true and the size of the outer\n" + "input is " +
                        "reduced enough (as specified in hive.optimize.limittranspose.reduction), the " + "limit is pushed\n" + "to the outer input or union; to " + "remain semantically correct, the limit is kept on top of the join or the union too" + "."),
        HIVE_OPTIMIZE_LIMIT_TRANSPOSE_REDUCTION_PERCENTAGE("hive.optimize.limittranspose.reductionpercentage", 1.0f, "When hive.optimize" +
                ".limittranspose is true, this variable specifies the minimal reduction of the\n" + "size of the outer input of the join or input of the " + "union that we should get in order to apply the rule."),
        HIVE_OPTIMIZE_LIMIT_TRANSPOSE_REDUCTION_TUPLES("hive.optimize.limittranspose.reductiontuples", (long) 0, "When hive.optimize" +
                ".limittranspose" + " is true, this variable specifies the minimal reduction in the\n" + "number of tuples of the outer input of the join " + "or the input of the " + "union that you should get in order to apply the rule."),
        ...
        HIVE_OPTIMIZE_SKEWJOIN_COMPILETIME("hive.optimize.skewjoin.compiletime", false, "Whether to create a separate plan for skewed keys for the "
                ...
                "generated above. So unless the same skewed key is present\n" + "in both the joined tables, the join for the skewed key will be " +
                "performed " + "as a map-side join.\n" + "\n" + "The main difference between this parameter and hive.optimize.skewjoin is that this " +
                "parameter\n" + "uses" + " the skew information stored in the metastore to optimize the plan at compile time itself.\n" + "If there is no "
                + "skew information in the" + " metadata, this parameter will not have any affect.\n" + "Both hive.optimize.skewjoin.compiletime and " +
                "hive" + ".optimize.skewjoin should be" + " set to true.\n" + "Ideally, hive.optimize.skewjoin should be renamed as hive.optimize" +
                ".skewjoin" + ".runtime, but not doing\n" + "so for " + "backward compatibility.\n" + "\n" + "If the skew information is correctly " +
                "stored in the " + "metadata, hive.optimize.skewjoin" + ".compiletime\n" + "would change the query plan to take care of it, and hive" +
        ...
        HIVEOPTINDEXFILTER_COMPACT_MAXSIZE("hive.optimize.index.filter.compact.maxsize", (long) -1, "Maximum size (in bytes) of the inputs on " +
                "which" + " a compact index is automatically used.  A negative number is equivalent to infinity."), // infinity
        HIVE_INDEX_COMPACT_QUERY_MAX_ENTRIES("hive.index.compact.query.max.entries", (long) 10000000, "The maximum number of index entries to read "
                + "during a query that uses the compact index. Negative value is equivalent to infinity."), // 10M
        HIVE_INDEX_COMPACT_QUERY_MAX_SIZE("hive.index.compact.query.max.size", (long) 10 * 1024 * 1024 * 1024, "The maximum number of bytes that a "
                + "query using the compact index can read. Negative value is equivalent to infinity."), // 10G
        ...
        // Statistics
        HIVESTATSAUTOGATHER("hive.stats.autogather", true, "A flag to gather statistics (only basic) automatically during the INSERT OVERWRITE " +
                "command."),
        HIVESTATSCOLAUTOGATHER("hive.stats.column.autogather", false, "A flag to gather column statistics automatically."),
        HIVESTATSDBCLASS("hive.stats.dbclass", "fs", new PatternSet("custom", "fs"), "The storage that stores temporary Hive statistics. In " +
                "filesystem based statistics collection ('fs'), \n" + "each task writes statistics it has collected in a file on the filesystem, which " +
        ...
        //Subset of counters that should be of interest for hive.client.stats.publishers (when one wants to limit their publishing). Non-display
        ...
        HIVE_STATS_COLLECT_PART_LEVEL_STATS("hive.analyze.stmt.collect.partlevel.stats", true,
                "analyze table T compute statistics for columns. " + "Queries like these should compute partition" + "level stats for partitioned table " + "even when no part spec is specified."),
        HIVE_STATS_GATHER_NUM_THREADS("hive.stats.gather.num.threads", 10, "Number of threads used by partialscan/noscan analyze command for " +
        ...
        HIVE_STATS_COLLECT_TABLEKEYS("hive.stats.collect.tablekeys", false,
                "Whether join and group by keys on tables are derived and maintained " + "in" + " the QueryPlan.\n" + "This is useful to identify how " +
                        "tables are accessed and to determine if they should be bucketed."),
        ...
        HIVE_STATS_COLLECT_SCANCOLS("hive.stats.collect.scancols", false, "Whether column accesses are tracked in the QueryPlan.\n" + "This is " +
                "useful to identify how tables are accessed and to determine if there are wasted columns that can be trimmed."),
        ...
        HIVE_METASTORE_STATS_NDV_TUNER("hive.metastore.stats.ndv.tuner", (float) 0.0,
                "Provides a tunable parameter between the lower bound and " + "the" + " higher bound of ndv for aggregate ndv across all the partitions. " +
                        "\n" + "The lower bound is equal to the maximum of ndv of all " + "the " + "partitions. The higher bound is equal to the sum of ndv of " +
        ...
        HIVE_STATS_MAP_NUM_ENTRIES("hive.stats.map.num.entries", 10, "To estimate the size of data flowing through operators in Hive/Tez(for " +
        ...
        HIVE_STATS_FETCH_PARTITION_STATS("hive.stats.fetch.partition.stats", true, "Annotation of operator tree with statistics information " +
                "requires partition level basic\n" + "statistics like number of rows, data size and file size. Partition statistics are fetched from\n" +
                "metastore. Fetching partition statistics for each needed partition can be expensive when the\n" + "number of partitions is high. This " +
                "flag can be used to disable fetching of partition statistics\n" + "from metastore. When this flag is disabled, Hive will make calls to " + "filesystem to get file sizes\n" + "and will estimate the number of rows from row schema."),
        ...
        HIVE_STATS_FETCH_COLUMN_STATS("hive.stats.fetch.column.stats", false,
                "Annotation of operator tree with statistics information requires " + "column statistics.\n" + "Column statistics are fetched from " +
                        "metastore. Fetching column statistics for each needed column\n" + "can be " + "expensive when the number of columns is high. This flag " + "can be used to disable fetching\n" + "of column statistics from metastore."),
        ...
        HIVE_STATS_JOIN_FACTOR("hive.stats.join.factor", (float) 1.1, "Hive/Tez optimizer estimates the data size flowing through each of the " +
        ...
        HIVE_STATS_DESERIALIZATION_FACTOR("hive.stats.deserialization.factor", (float) 1.0,
                "Hive/Tez optimizer estimates the data size flowing " + "through each of the operators. In the absence\n" + "of basic statistics like " +
                        "number of rows and data size, file size is used to estimate " + "the number\n" + "of rows and data size. Since files in " + "tables" +
                        "/partitions are serialized (and optionally\n" + "compressed) the estimates " + "of number of rows and data size cannot be " + "reliably " +
        ...
        HIVE_LOCK_SLEEP_BETWEEN_RETRIES("hive.lock.sleep.between.retries", "60s", new TimeValidator(TimeUnit.SECONDS, 0L, false, Long.MAX_VALUE,
                false), "The maximum sleep time between various retries"),
        HIVE_LOCK_MAPRED_ONLY("hive.lock.mapred.only.operation", false, "This param is to control whether or not only do lock on queries\n" + "that"
                + " need to execute at least one mapred job."),
        
        // Zookeeper related configs
        HIVE_ZOOKEEPER_QUORUM("hive.zookeeper.quorum", "", "List of ZooKeeper servers to talk to. This is needed for: \n" + "1. Read/write locks - "
                + "when hive.lock.manager is set to \n" + "org.apache.hadoop.hive.ql.lockmgr.zookeeper.ZooKeeperHiveLockManager, \n" + "2. When " +
                "HiveServer2 " + "supports service discovery via Zookeeper.\n" + "3. For delegation token storage if zookeeper store is used, if\n" +
                "hive.cluster" + ".delegation.token.store.zookeeper.connectString is not set\n" + "4. LLAP daemon registry service"),
        
        HIVE_ZOOKEEPER_CLIENT_PORT("hive.zookeeper.client.port", "2181", "The port of ZooKeeper servers to talk to.\n" + "If the list of Zookeeper "
                + "servers specified in hive.zookeeper.quorum\n" + "does not contain port numbers, this value is used."),
        HIVE_ZOOKEEPER_SESSION_TIMEOUT("hive.zookeeper.session.timeout", "1200000ms", new TimeValidator(TimeUnit.MILLISECONDS), "ZooKeeper " +
                "client's" + " session timeout (in milliseconds). The client is disconnected, and as a result, all locks released, \n" + "if a heartbeat " + "is not sent in" + " the timeout."),
        HIVE_ZOOKEEPER_NAMESPACE("hive.zookeeper.namespace", "hive_zookeeper_namespace", "The parent node under which all ZooKeeper nodes are " +
                "created."),
        HIVE_ZOOKEEPER_CLEAN_EXTRA_NODES("hive.zookeeper.clean.extra.nodes", false, "Clean extra nodes at the end of the session."),
        HIVE_ZOOKEEPER_CONNECTION_MAX_RETRIES("hive.zookeeper.connection.max.retries", 3, "Max number of times to retry when connecting to the " +
                "ZooKeeper server."),
        HIVE_ZOOKEEPER_CONNECTION_BASESLEEPTIME("hive.zookeeper.connection.basesleeptime", "1000ms", new TimeValidator(TimeUnit.MILLISECONDS),
        ...
        // Transactions
        HIVE_TXN_MANAGER("hive.txn.manager", "org.apache.hadoop.hive.ql.lockmgr.DummyTxnManager", "Set to org.apache.hadoop.hive.ql.lockmgr" +
                ".DbTxnManager as part of turning on Hive\n" + "transactions, which also requires appropriate settings for hive.compactor.initiator.on,\n" + "hive.compactor.worker.threads, hive.support.concurrency (true),\n" + "and hive.exec.dynamic.partition.mode (nonstrict).\n" + "The default " + "DummyTxnManager replicates pre-Hive-0.13 behavior and provides\n" + "no transactions."),
        HIVE_TXN_STRICT_LOCKING_MODE("hive.txn.strict.locking.mode", true, "In strict mode non-ACID\n" + "resources use standard R/W lock " +
                "semantics, e.g. INSERT will acquire exclusive lock.\n" + "In nonstrict mode, for non-ACID resources, INSERT will only acquire shared " +
        ...
        HIVE_TXN_HEARTBEAT_THREADPOOL_SIZE("hive.txn.heartbeat.threadpool.size", 5,
        ...
        TXN_MGR_DUMP_LOCK_STATE_ON_ACQUIRE_TIMEOUT("hive.txn.manager.dump.lock.state.on.acquire.timeout", false,
                "Set this to true so that when " + "attempt to acquire a lock on resource times out, the current state" + " of the lock manager is dumped "
                        + "to log file.  This is for debugging" + ".  See also " + "hive.lock.numretries and hive.lock.sleep.between.retries."),
        
        HIVE_TXN_OPERATIONAL_PROPERTIES("hive.txn.operational.properties", 0, "Sets the operational properties that control the appropriate " +
                "behavior for various\n" + "versions of the Hive ACID subsystem. Setting it to zero will turn on the legacy mode\n" + "for ACID, while " +
                "setting it to one will enable a split-update feature found in the newer\n" + "version of Hive ACID subsystem. Mostly it is intended to " + "be" + " used as an internal property\n" + "for future versions of ACID. (See HIVE-14035 for details.)"),
        
        HIVE_MAX_OPEN_TXNS("hive.max.open.txns", 100000, "Maximum number of open transactions. If \n" + "current open transactions reach this " +
                "limit, future open transaction requests will be \n" + "rejected, until this number goes below the limit."),
        HIVE_COUNT_OPEN_TXNS_INTERVAL("hive.count.open.txns.interval", "1s", new TimeValidator(TimeUnit.SECONDS),
                "Time in seconds between checks " + "to count open transactions."),
        
        HIVE_TXN_MAX_OPEN_BATCH("hive.txn.max.open.batch", 1000,
                "Maximum number of transactions that can be fetched in one call to open_txns().\n" + "This controls how many transactions streaming " +
                        "agents" + " such as Flume or Storm open\n" + "simultaneously. The streaming agent then writes " + "that number of entries into a " +
        ...
        HIVE_COMPACTOR_INITIATOR_ON("hive.compactor.initiator.on", false, "Whether to run the initiator and cleaner threads on this metastore " +
                "instance or not.\n" + "Set this to true on one instance of the Thrift metastore service as part of turning\n" + "on Hive transactions. " + "For a complete list of parameters required for turning on\n" + "transactions, see hive.txn.manager."),
        
        HIVE_COMPACTOR_WORKER_THREADS("hive.compactor.worker.threads", 0,
                "How many compactor worker threads to run on this metastore instance. " + "Set" + " this to a\n" + "positive number on one or more " +
                        "instances of the Thrift metastore service as part of\n" + "turning on Hive " + "transactions. " + "For a complete list of parameters " +
                        "required for turning\n" + "on transactions, see hive.txn.manager.\n" + "Worker " + "threads spawn MapReduce" + " " + "jobs to do " +
                        "compactions. They do not do the compactions\n" + "themselves. Increasing the number of " + "worker threads will decrease the " + "time" +
                        " " + "it takes\n" + "tables or partitions to be compacted once they are determined to need " + "compaction.\n" + "It will also " +
                        "increase the " + "background load on the Hadoop cluster as more MapReduce jobs\n" + "will be running " + "in the background."),
        
        HIVE_COMPACTOR_WORKER_TIMEOUT("hive.compactor.worker.timeout", "86400s", new TimeValidator(TimeUnit.SECONDS), "Time in seconds after which "
                + "a compaction job will be declared failed and the\n" + "compaction re-queued."),
        
        HIVE_COMPACTOR_CHECK_INTERVAL("hive.compactor.check.interval", "300s", new TimeValidator(TimeUnit.SECONDS), "Time in seconds between " +
                "checks" + " to see if any tables or partitions need to be\n" + "compacted. This should be kept high because each check for compaction " +
                "requires\n" + "many" + " calls against the NameNode.\n" + "Decreasing this value will reduce the time it takes for compaction to be " +
                "started\n" + "for a table" + " or" + " partition that requires compaction. However, checking if compaction\n" + "is needed requires " +
                "several calls to the NameNode for each " + "table or partition that\n" + "has had a transaction done on it since the last major " +
                "compaction. So decreasing this\n" + "value will " + "increase the load on the NameNode."),
        
        HIVE_COMPACTOR_DELTA_NUM_THRESHOLD("hive.compactor.delta.num.threshold", 10, "Number of delta directories in a table or partition that " +
                "will" + " trigger a minor\n" + "compaction."),
        
        HIVE_COMPACTOR_DELTA_PCT_THRESHOLD("hive.compactor.delta.pct.threshold", 0.1f,
                "Percentage (fractional) size of the delta files relative " + "to" + " the base that will trigger\n" + "a major compaction. (1.0 = 100%, " +
                        "so the default 0.1 = 10%.)"),
        COMPACTOR_MAX_NUM_DELTA("hive.compactor.max.num.delta", 500, "Maximum number of delta files that " + "the compactor will attempt to handle "
                + "in a single job."),
        ...
        COMPACTOR_INITIATOR_FAILED_THRESHOLD("hive.compactor.initiator.failed.compacts.threshold", 2, new RangeValidator(1, 20), "Number of " +
                "consecutive compaction failures (per table/partition) " + "after which automatic compactions will not be scheduled any more.  Note that " + "this must be less " + "than hive.compactor.history.retention.failed."),
        
        HIVE_COMPACTOR_CLEANER_RUN_INTERVAL("hive.compactor.cleaner.run.interval", "5000ms", new TimeValidator(TimeUnit.MILLISECONDS), "Time " +
                "between runs of the cleaner thread"),
        COMPACTOR_JOB_QUEUE("hive.compactor.job.queue", "",
                "Used to specify name of Hadoop queue to which\n" + "Compaction jobs will be submitted" + "." + "  Set to empty string to let Hadoop " +
                        "choose the queue."),
        
        COMPACTOR_HISTORY_RETENTION_SUCCEEDED("hive.compactor.history.retention.succeeded", 3, new RangeValidator(0, 100),
                "Determines how many " + "successful compaction records will be " + "retained in compaction history for a given table/partition."),
        
        COMPACTOR_HISTORY_RETENTION_FAILED("hive.compactor.history.retention.failed", 3, new RangeValidator(0, 100),
                "Determines how many failed " + "compaction records will be " + "retained in compaction history for a given table/partition."),
        
        COMPACTOR_HISTORY_RETENTION_ATTEMPTED("hive.compactor.history.retention.attempted", 2, new RangeValidator(0, 100),
                "Determines how many " + "attempted compaction records will be " + "retained in compaction history for a given table/partition."),
        
        COMPACTOR_HISTORY_REAPER_INTERVAL("hive.compactor.history.reaper.interval", "2m", new TimeValidator(TimeUnit.MILLISECONDS),
                "Determines " + "how" + " often compaction history reaper runs"),
        
        HIVE_TIMEDOUT_TXN_REAPER_START("hive.timedout.txn.reaper.start", "100s", new TimeValidator(TimeUnit.MILLISECONDS), "Time delay of 1st " +
                "reaper run after metastore start"),
        HIVE_TIMEDOUT_TXN_REAPER_INTERVAL("hive.timedout.txn.reaper.interval", "180s", new TimeValidator(TimeUnit.MILLISECONDS),
                "Time interval " + "describing how often the reaper runs"),
        WRITE_SET_REAPER_INTERVAL("hive.writeset.reaper.interval", "60s", new TimeValidator(TimeUnit.MILLISECONDS),
                "Frequency of WriteSet reaper " + "runs"),
        
        MERGE_CARDINALITY_VIOLATION_CHECK("hive.merge.cardinality.check", true,
                "Set to true to ensure that each SQL Merge statement ensures that " + "for each row in the target\n" + "table there is at most 1 matching "
                        + "row in the source table per SQL Specification."),
        
        // For Druid storage handler
        HIVE_DRUID_INDEXING_GRANULARITY("hive.druid.indexer.segments.granularity", "DAY", new PatternSet("YEAR", "MONTH", "WEEK", "DAY", "HOUR",
                "MINUTE", "SECOND"), "Granularity for the segments created by the Druid storage handler"),
        ...
        HIVE_DRUID_MAX_ROW_IN_MEMORY("hive.druid.indexer.memory.rownum.max", 75000, "Maximum number of records in memory while storing data in " +
                "Druid"),
        ...
        HIVE_DRUID_SELECT_DISTRIBUTE("hive.druid.select.distribute", true, "If it is set to true, we distribute the execution of Druid Select " +
        ...
        DRUID_METADATA_DB_TYPE("hive.druid.metadata.db.type", "mysql", new PatternSet("mysql", "postgresql"), "Type of the metadata database."),
        ...
        DRUID_WORKING_DIR("hive.druid.working.directory", "/tmp/workingDirectory", "Default hdfs working directory used to store some intermediate "
                + "metadata"),
        ...
        HIVE_HBASE_WAL_ENABLED("hive.hbase.wal.enabled", true,
                "Whether writes to HBase should be forced to the write-ahead log. \n" + "Disabling " + "this improves HBase write performance at the risk "
                        + "of lost writes in case of a crash."),
        ...
        HIVEFETCHTASKCONVERSION("hive.fetch.task.conversion", "more", new StringSet("none", "minimal", "more"), "Some select queries can be " +
                "converted to single FETCH task minimizing latency.\n" + "Currently the query should be single sourced not having any subquery and should " + "not have\n" + "any aggregations or distincts (which incurs RS), lateral views and joins.\n" + "0. none : disable hive.fetch.task" + ".conversion\n" + "1. minimal : SELECT STAR, FILTER on partition columns, LIMIT only\n" + "2. more    : SELECT, FILTER, LIMIT only " + "(support TABLESAMPLE and virtual columns)"),
        HIVEFETCHTASKCONVERSIONTHRESHOLD("hive.fetch.task.conversion.threshold", 1073741824L, "Input threshold for applying hive.fetch.task" +
                ".conversion. If target table is native, input length\n" + "is calculated by summation of file lengths. If it's not native, storage " +
                "handler for the table\n" + "can optionally implement org.apache.hadoop.hive.ql.metadata.InputEstimator interface."),
        
        HIVEFETCHTASKAGGR("hive.fetch.task.aggr", false, "Aggregation queries with no group-by clause (for example, select count(*) from src) " +
                "execute\n" + "final aggregations in single reduce task. If this is set true, Hive delegates final aggregation\n" + "stage to fetch task, " + "possibly decreasing the query time."),
        
        HIVEOPTIMIZEMETADATAQUERIES("hive.compute.query.using.stats", true,
                "When set to true Hive will answer a few queries like count(1) purely " + "using stats\n" + "stored in metastore. For basic stats " +
                        "collection turn on the config hive.stats.autogather to true.\n" + "For more " + "advanced stats collection need to run analyze table " +
                        "queries."),
        
        // Serde for FetchTask
        HIVEFETCHOUTPUTSERDE("hive.fetch.output.serde", "org.apache.hadoop.hive.serde2.DelimitedJSONSerDe", "The SerDe used by FetchTask to " +
                "serialize the fetch output."),
        
        HIVEEXPREVALUATIONCACHE("hive.cache.expr.evaluation", true, "If true, the evaluation result of a deterministic expression referenced twice "
                + "or more\n" + "will be cached.\n" + "For example, in a filter condition like '.. where key + 10 = 100 or key + 10 = 0'\n" + "the " +
                "expression 'key + 10' will be evaluated/cached once and reused for the following\n" + "expression ('key + 10 = 0'). Currently, this is " + "applied only to expressions in select\n" + "or filter operators."),
        ...
        HIVE_AUTHORIZATION_MANAGER("hive.security.authorization.manager", "org.apache.hadoop.hive.ql.security.authorization.plugin.sqlstd" +
        ...
        HIVE_AUTHENTICATOR_MANAGER("hive.security.authenticator.manager", "org.apache.hadoop.hive.ql.security.HadoopDefaultAuthenticator",
                "hive " + "client authenticator manager class name. The user defined authenticator should implement \n" + "interface org.apache.hadoop" +
                        ".hive.ql" + ".security.HiveAuthenticationProvider."),
        HIVE_METASTORE_AUTHORIZATION_MANAGER("hive.security.metastore.authorization.manager", "org.apache.hadoop.hive.ql.security.authorization" +
                ".DefaultHiveMetastoreAuthorizationProvider", "Names of authorization manager classes (comma separated) to be used in the metastore\n" +
                "for " + "authorization. The user defined authorization class should implement interface\n" + "org.apache.hadoop.hive.ql.security" +
                ".authorization" + ".HiveMetastoreAuthorizationProvider.\n" + "All authorization manager classes have to successfully authorize the " +
        ...
        HIVE_METASTORE_AUTHENTICATOR_MANAGER("hive.security.metastore.authenticator.manager", "org.apache.hadoop.hive.ql.security" +
                ".HadoopDefaultMetastoreAuthenticator",
                "authenticator manager class name to be used in the metastore for authentication. \n" + "The user " + "defined authenticator should " +
        ...
        HIVE_AUTHORIZATION_TABLE_USER_GRANTS("hive.security.authorization.createtable.user.grants", "",
                "the privileges automatically granted to " + "some users whenever a table gets created.\n" + "An example like \"userX,userY:select;" +
                        "userZ:create\" will grant select privilege to userX " + "and userY,\n" + "and grant create privilege to userZ whenever a new table " +
                        "created."),
        HIVE_AUTHORIZATION_TABLE_GROUP_GRANTS("hive.security.authorization.createtable.group.grants", "", "the privileges automatically granted to "
                + "some groups whenever a table gets created.\n" + "An example like \"groupX,groupY:select;groupZ:create\" will grant select privilege to "
        ...
        HIVE_AUTHORIZATION_TABLE_ROLE_GRANTS("hive.security.authorization.createtable.role.grants", "",
                "the privileges automatically granted to " + "some roles whenever a table gets created.\n" + "An example like \"roleX,roleY:select;" +
                        "roleZ:create\" will grant select privilege to roleX " + "and roleY,\n" + "and grant create privilege to roleZ whenever a new table " +
                        "created."),
        HIVE_AUTHORIZATION_TABLE_OWNER_GRANTS("hive.security.authorization.createtable.owner.grants", "", "The privileges automatically granted to "
                + "the owner whenever a table gets created.\n" + "An example like \"select,drop\" will grant select and drop privilege to the owner\n" +
                "of" + " the table. Note that the default gives the creator of a table no access to the\n" + "table (but see HIVE-8067)."),
        HIVE_AUTHORIZATION_TASK_FACTORY("hive.security.authorization.task.factory", "org.apache.hadoop.hive.ql.parse.authorization" +
                ".HiveAuthorizationTaskFactoryImpl", "Authorization DDL task factory implementation"),
        ...
        HIVE_INDEX_IGNORE_HDFS_LOC("hive.index.compact.file.ignore.hdfs", false, "When true the HDFS location stored in the index file will be " +
        ...
        HIVE_EXIM_RESTRICT_IMPORTS_INTO_REPLICATED_TABLES("hive.exim.strict.repl.tables", true,
                "Parameter that determines if 'regular' " + "(non" + "-replication) export dumps can be\n" + "imported on to tables that are the target " +
                        "of" + " replication. If this parameter is\n" + "set, " + "regular imports will check if the destination table(if it exists) has a " +
                        "'repl" + ".last.id' set on it. If so, it will fail."),
        HIVE_REPL_TASK_FACTORY("hive.repl.task.factory", "org.apache.hive.hcatalog.api.repl.exim.EximReplicationTaskFactory",
                "Parameter that can " + "be used to override which ReplicationTaskFactory will be\n" + "used to instantiate ReplicationTask events. " +
                        "Override for third party repl " + "plugins"),
        HIVE_MAPPER_CANNOT_SPAN_MULTIPLE_PARTITIONS("hive.mapper.cannot.span.multiple.partitions", false, ""),
        HIVE_REWORK_MAPREDWORK("hive.rework.mapredwork", false, "should rework the mapred work or not.\n" + "This is first introduced by " +
                "SymlinkTextInputFormat to replace symlink files with real paths at compile time."),
        HIVE_CONCATENATE_CHECK_INDEX("hive.exec.concatenate.check.index", true, "If this is set to true, Hive will throw error when doing\n" +
                "'alter " + "table tbl_name [partSpec] concatenate' on a table/partition\n" + "that has indexes on it. The reason the user want to set " +
                "this" + " to " + "true\n" + "is because it can help user to avoid handling all index drop, recreation,\n" + "rebuild work. This is very " +
                "helpful " + "for tables " + "with " + "thousands of partitions."),
        HIVE_IO_EXCEPTION_HANDLERS("hive.io.exception.handlers", "",
                "A list of io exception handler class names. This is used\n" + "to construct " + "a" + " list exception handlers to handle exceptions " +
                        "thrown\n" + "by record readers"),
        
        // logging configuration
        HIVE_LOG4J_FILE("hive.log4j.file", "",
                "Hive log4j configuration file.\n" + "If the property is not set, then logging will be initialized " + "using hive-log4j2.properties " +
                        "found" + " on the classpath.\n" + "If the property is set, the value must be a valid URI (java.net.URI, e.g. " + "\"file:///tmp/my" +
        ...
        HIVE_ASYNC_LOG_ENABLED("hive.async.log.enabled", true,
                "Whether to enable Log4j2's asynchronous logging. Asynchronous logging can give\n" + " " + "significant performance improvement as " +
                        "logging" + " will" + " be handled in separate thread\n" + " that uses LMAX disruptor queue for buffering " + "log messages.\n" + " Refer" +
                        " " + "https://logging.apache" + ".org/log4j/2.x/manual/async.html for benefits and\n" + " drawbacks."),
        
        HIVE_LOG_EXPLAIN_OUTPUT("hive.log.explain.output", false, "Whether to log explain output for every query.\n" + "When enabled, will log " +
                "EXPLAIN EXTENDED output for the query at INFO log4j log level."),
        ...
        HIVE_AUTOGEN_COLUMNALIAS_PREFIX_LABEL("hive.autogen.columnalias.prefix.label", "_c",
                "String used as a prefix when auto generating column " + "alias.\n" + "By default the prefix label will be appended with a column " +
                        "position" + " number to form the column alias. \n" + "Auto generation " + "would happen if an aggregate function is used in a select " +
                        "clause without " + "an explicit alias."),
        HIVE_AUTOGEN_COLUMNALIAS_PREFIX_INCLUDEFUNCNAME("hive.autogen.columnalias.prefix.includefuncname", false, "Whether to include function " +
                "name" + " in the column alias auto generated by Hive."),
        HIVE_METRICS_CLASS("hive.service.metrics.class", "org.apache.hadoop.hive.common.metrics.metrics2.CodahaleMetrics", new StringSet("org" +
                ".apache.hadoop.hive.common.metrics.metrics2.CodahaleMetrics", "org.apache.hadoop.hive.common.metrics.LegacyMetrics"), "Hive metrics " +
                "subsystem implementation class."),
        HIVE_METRICS_REPORTER("hive.service.metrics.reporter", "JSON_FILE, JMX", "Reporter type for metric class org.apache.hadoop.hive.common" +
                ".metrics.metrics2.CodahaleMetrics, " + "comma separated list of JMX, CONSOLE, JSON_FILE, HADOOP2"),
        HIVE_METRICS_JSON_FILE_LOCATION("hive.service.metrics.file.location", "/tmp/report.json",
                "For metric class org.apache.hadoop.hive.common" + ".metrics.metrics2.CodahaleMetrics JSON_FILE reporter, the location of local JSON " +
                        "metrics file.  " + "This file will get overwritten at " + "every interval."),
        HIVE_METRICS_JSON_FILE_INTERVAL("hive.service.metrics.file.frequency", "5s", new TimeValidator(TimeUnit.MILLISECONDS),
        ...
        HIVE_METRICS_HADOOP2_INTERVAL("hive.service.metrics.hadoop2.frequency", "30s", new TimeValidator(TimeUnit.SECONDS),
                "For metric class org" + ".apache.hadoop.hive.common.metrics.metrics2.CodahaleMetrics HADOOP2 reporter, " + "the frequency of updating " +
                        "the" + " HADOOP2 metrics system."),
        HIVE_METRICS_HADOOP2_COMPONENT_NAME("hive.service.metrics.hadoop2.component", "hive",
                "Component name to provide to Hadoop2 Metrics system" + "." + " Ideally 'hivemetastore' for the MetaStore " + " and and 'hiveserver2' for " +
                        "HiveServer2."),
        HIVE_PERF_LOGGER("hive.exec.perf.logger", "org.apache.hadoop.hive.ql.log.PerfLogger", "The class responsible for logging client side " +
        ...
        HIVE_WAREHOUSE_SUBDIR_INHERIT_PERMS("hive.warehouse.subdir.inherit.perms", true, "Set this to false if the table directories should be " +
                "created\n" + "with the permissions derived from dfs umask instead of\n" + "inheriting the permission of the warehouse or database " +
                "directory."),
        HIVE_INSERT_INTO_EXTERNAL_TABLES("hive.insert.into.external.tables", true, "whether insert into external tables is allowed"),
        HIVE_TEMPORARY_TABLE_STORAGE("hive.exec.temporary.table.storage", "default", new StringSet("memory", "ssd", "default"), "Define the " +
                "storage" + " policy for temporary tables." + "Choices between memory, ssd and default"),
        ...
        HIVE_DRIVER_RUN_HOOKS("hive.exec.driver.run.hooks", "", "A comma separated list of hooks which implement HiveDriverRunHook. Will be run at "
                + "the beginning " + "and end of Driver.run, these will be run in the order specified."),
        ...
        HIVE_DISPLAY_PARTITION_COLUMNS_SEPARATELY("hive.display.partition.cols.separately", true, "In older Hive version (0.10 and earlier) no " +
        ...
        HIVE_SERVER2_CLEAR_DANGLING_SCRATCH_DIR_INTERVAL("hive.server2.clear.dangling.scratchdir.interval", "1800s",
                new TimeValidator(TimeUnit.SECONDS), "Interval to clear dangling scratch dir periodically in HS2"),
        HIVE_SERVER2_SLEEP_INTERVAL_BETWEEN_START_ATTEMPTS("hive.server2.sleep.interval.between.start.attempts", "60s",
        ...
        HIVE_SERVER2_MAX_START_ATTEMPTS("hive.server2.max.start.attempts", 30L, new RangeValidator(0L, null),
                "Number of times HiveServer2 will " + "attempt to start before exiting. The sleep interval between retries" + " is determined by " + ConfVars.HIVE_SERVER2_SLEEP_INTERVAL_BETWEEN_START_ATTEMPTS.varname + "\n The default of 30 will keep trying for 30 minutes."),
        HIVE_SERVER2_SUPPORT_DYNAMIC_SERVICE_DISCOVERY("hive.server2.support.dynamic.service.discovery", false, "Whether HiveServer2 supports " +
                "dynamic service discovery for its clients. " + "To support this, each instance of HiveServer2 currently uses ZooKeeper to register " +
                "itself, " + "when it is brought up. JDBC/ODBC clients should use the ZooKeeper ensemble: " + "hive.zookeeper.quorum in their connection " + "string."),
        HIVE_SERVER2_ZOOKEEPER_NAMESPACE("hive.server2.zookeeper.namespace", "hiveserver2", "The parent node in ZooKeeper used by HiveServer2 when "
                + "supporting dynamic service discovery."),
        HIVE_SERVER2_ZOOKEEPER_PUBLISH_CONFIGS("hive.server2.zookeeper.publish.configs", true, "Whether we should publish HiveServer2's configs to "
                + "ZooKeeper."),
        
        // HiveServer2 global init file location
        HIVE_SERVER2_GLOBAL_INIT_FILE_LOCATION("hive.server2.global.init.file.location", "${env:HIVE_CONF_DIR}", "Either the location of a HS2 " +
                "global init file or a directory containing a .hiverc file. If the \n" + "property is set, the value must be a valid path to an init file " + "or directory where the init file is located."),
        HIVE_SERVER2_TRANSPORT_MODE("hive.server2.transport.mode", "binary", new StringSet("binary", "http"), "Transport mode of HiveServer2."),
        HIVE_SERVER2_THRIFT_BIND_HOST("hive.server2.thrift.bind.host", "", "Bind host on which to run the HiveServer2 Thrift service."),
        HIVE_SERVER2_PARALLEL_COMPILATION("hive.driver.parallel.compilation", false,
                "Whether to\n" + "enable parallel compilation of the queries " + "between sessions and within the same session on HiveServer2. The " +
                        "default" + " is false."),
        HIVE_SERVER2_COMPILE_LOCK_TIMEOUT("hive.server2.compile.lock.timeout", "0s", new TimeValidator(TimeUnit.SECONDS), "Number of seconds a " +
                "request will wait to acquire the compile lock before giving up. " + "Setting it to 0s disables the timeout."),
        ...
        HIVE_SERVER2_WEBUI_PORT("hive.server2.webui.port", 10002,
                "The port the HiveServer2 WebUI will listen on. This can be" + "set to 0 or a " + "negative integer to disable the web UI"),
        ...
        HIVE_SERVER2_WEBUI_USE_SPNEGO("hive.server2.webui.use.spnego", false, "If true, the HiveServer2 WebUI will be secured with SPNEGO. Clients "
        ...
        HIVE_SERVER2_WEBUI_SPNEGO_PRINCIPAL("hive.server2.webui.spnego.principal", "HTTP/_HOST@EXAMPLE.COM", "The HiveServer2 WebUI SPNEGO service "
                + "principal.\n" + "The special string _HOST will be replaced automatically with \n" + "the value of hive.server2.webui.host or the " +
                "correct " + "host name."),
        HIVE_SERVER2_WEBUI_MAX_HISTORIC_QUERIES("hive.server2.webui.max.historic.queries", 25, "The maximum number of past queries to show in " +
                "HiverSever2 WebUI."),
        
        // Tez session settings
        HIVE_SERVER2_TEZ_DEFAULT_QUEUES("hive.server2.tez.default.queues", "",
                "A list of comma separated values corresponding to YARN queues of " + "the same name.\n" + "When HiveServer2 is launched in Tez mode, " +
                        "this" + " configuration needs to be set\n" + "for multiple Tez sessions to run " + "in parallel on the cluster."),
        HIVE_SERVER2_TEZ_SESSIONS_PER_DEFAULT_QUEUE("hive.server2.tez.sessions.per.default.queue", 1, "A positive integer that determines the " +
                "number of Tez sessions that should be\n" + "launched on each of the queues specified by \"hive.server2.tez.default.queues\".\n" +
        ...
        HIVE_SERVER2_TEZ_SESSION_LIFETIME("hive.server2.tez.session.lifetime", "162h", new TimeValidator(TimeUnit.HOURS), "The lifetime of the Tez "
                + "sessions launched by HS2 when default sessions are enabled.\n" + "Set to 0 to disable session expiration."),
        HIVE_SERVER2_TEZ_SESSION_LIFETIME_JITTER("hive.server2.tez.session.lifetime.jitter", "3h", new TimeValidator(TimeUnit.HOURS),
        ...
        HIVE_SERVER2_TEZ_SESSION_MAX_INIT_THREADS("hive.server2.tez.sessions.init.threads", 16,
                "If hive.server2.tez.initialize.default.sessions " + "is" + " enabled, the maximum number of\n" + "threads to use to initialize the " +
                        "default sessions."),
        HIVE_SERVER2_TEZ_SESSION_RESTRICTED_CONFIGS("hive.server2.tez.sessions.restricted.configs", "", "The configuration settings that cannot be "
                + "set when submitting jobs to HiveServer2. If\n" + "any of these are set to values different from those in the server configuration, " +
                "an\n" + "exception will be thrown."),
        HIVE_SERVER2_TEZ_SESSION_CUSTOM_QUEUE_ALLOWED("hive.server2.tez.sessions.custom.queue.allowed", "true", new StringSet("true", "false",
                "ignore"), "Whether Tez session pool should allow submitting queries to custom queues. The options\n" + "are true, false (error out), " +
                "ignore (accept the query but ignore the queue setting)."),
        ...
        HIVE_SERVER2_LOGGING_OPERATION_LOG_LOCATION("hive.server2.logging.operation.log.location", "${system:java.io.tmpdir}" + File.separator + "$"
                + "{system:user.name}" + File.separator + "operation_logs", "Top level directory where operation logs are stored if logging functionality "
                + "is" + " enabled"),
        HIVE_SERVER2_LOGGING_OPERATION_LEVEL("hive.server2.logging.operation.level", "EXECUTION", new StringSet("NONE", "EXECUTION", "PERFORMANCE",
                "VERBOSE"), "HS2 operation logging mode available to clients to be set at session level.\n" + "For this to work, hive.server2.logging" +
                ".operation.enabled should be set to true.\n" + "  NONE: Ignore any logging\n" + "  EXECUTION: Log completion of tasks\n" + "  " +
        ...
        HIVE_SERVER2_THRIFT_HTTP_PORT("hive.server2.thrift.http.port", 10001, "Port number of HiveServer2 Thrift interface when hive.server2" +
                ".transport.mode is 'http'."),
        HIVE_SERVER2_THRIFT_HTTP_PATH("hive.server2.thrift.http.path", "cliservice", "Path component of URL endpoint when in HTTP mode."),
        HIVE_SERVER2_THRIFT_MAX_MESSAGE_SIZE("hive.server2.thrift.max.message.size", 100 * 1024 * 1024, "Maximum message size in bytes a HS2 " +
                "server" + " will accept."),
        ...
        HIVE_SERVER2_THRIFT_HTTP_REQUEST_HEADER_SIZE("hive.server2.thrift.http.request.header.size", 6 * 1024, "Request header size in bytes, when "
                + "using HTTP transport mode. Jetty defaults used."),
        ...
        HIVE_SERVER2_THRIFT_HTTP_COOKIE_AUTH_ENABLED("hive.server2.thrift.http.cookie.auth.enabled", true, "When true, HiveServer2 in HTTP " +
                "transport mode, will use cookie based authentication mechanism."),
        HIVE_SERVER2_THRIFT_HTTP_COOKIE_MAX_AGE("hive.server2.thrift.http.cookie.max.age", "86400s", new TimeValidator(TimeUnit.SECONDS), "Maximum "
                + "age in seconds for server side cookie used by HS2 in HTTP mode."),
        HIVE_SERVER2_THRIFT_HTTP_COOKIE_DOMAIN("hive.server2.thrift.http.cookie.domain", null, "Domain for the HS2 generated cookies"),
        HIVE_SERVER2_THRIFT_HTTP_COOKIE_PATH("hive.server2.thrift.http.cookie.path", null, "Path for the HS2 generated cookies"),
        @Deprecated HIVE_SERVER2_THRIFT_HTTP_COOKIE_IS_SECURE("hive.server2.thrift.http.cookie.is.secure", true,
        ...
        HIVE_SERVER2_THRIFT_LOGIN_BEBACKOFF_SLOT_LENGTH("hive.server2.thrift.exponential.backoff.slot.length", "100ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Binary exponential backoff slot time for Thrift clients during login to HiveServer2,\n" + "for "
                + "retries until hitting Thrift client timeout"),
        HIVE_SERVER2_THRIFT_LOGIN_TIMEOUT("hive.server2.thrift.login.timeout", "20s", new TimeValidator(TimeUnit.SECONDS), "Timeout for Thrift " +
                "clients during login to HiveServer2"),
        ...
        HIVE_SERVER2_ASYNC_EXEC_SHUTDOWN_TIMEOUT("hive.server2.async.exec.shutdown.timeout", "10s", new TimeValidator(TimeUnit.SECONDS), "How long "
                + "HiveServer2 shutdown will wait for async threads to terminate."),
        HIVE_SERVER2_ASYNC_EXEC_WAIT_QUEUE_SIZE("hive.server2.async.exec.wait.queue.size", 100,
                "Size of the wait queue for async thread pool in " + "HiveServer2.\n" + "After hitting this limit, the async thread pool will reject new " + "requests."),
        HIVE_SERVER2_ASYNC_EXEC_KEEPALIVE_TIME("hive.server2.async.exec.keepalive.time", "10s", new TimeValidator(TimeUnit.SECONDS), "Time that an "
                + "idle HiveServer2 async thread (from the thread pool) will wait for a new task\n" + "to arrive before terminating"),
        HIVE_SERVER2_ASYNC_EXEC_ASYNC_COMPILE("hive.server2.async.exec.async.compile", false, "Whether to enable compiling async query " +
                "asynchronously. If enabled, it is unknown if the query will have any resultset before compilation completed."),
        HIVE_SERVER2_LONG_POLLING_TIMEOUT("hive.server2.long.polling.timeout", "5000ms", new TimeValidator(TimeUnit.MILLISECONDS), "Time that " +
                "HiveServer2 will wait before responding to asynchronous calls that use long polling"),
        
        HIVE_SESSION_IMPL_CLASSNAME("hive.session.impl.classname", null, "Classname for custom implementation of hive session"),
        HIVE_SESSION_IMPL_WITH_UGI_CLASSNAME("hive.session.impl.withugi.classname", null, "Classname for custom implementation of hive session " +
                "with" + " UGI"),
        ...
        HIVE_SERVER2_ALLOW_USER_SUBSTITUTION("hive.server2.allow.user.substitution", true, "Allow alternate user to be specified as part of " +
                "HiveServer2 open connection request."),
        ...
        HIVE_SERVER2_PLAIN_LDAP_URL("hive.server2.authentication.ldap.url", null,
                "LDAP connection URL(s),\n" + "this value could contain URLs to " + "mutiple LDAP servers instances for HA,\n" + "each LDAP URL is " +
                        "separated by a SPACE character. URLs are used in the \n" + " order " + "specified until a connection is successful."),
        ...
        HIVE_SERVER2_PLAIN_LDAP_GROUPFILTER("hive.server2.authentication.ldap.groupFilter", null, "COMMA-separated list of LDAP Group names (short "
        ...
        HIVE_SERVER2_PLAIN_LDAP_USERFILTER("hive.server2.authentication.ldap.userFilter", null, "COMMA-separated list of LDAP usernames (just " +
                "short" + " names, not full DNs).\n" + "For example: hiveuser,impalauser,hiveadmin,hadoopadmin"),
        ...
        HIVE_SERVER2_PLAIN_LDAP_GROUPMEMBERSHIP_KEY("hive.server2.authentication.ldap.groupMembershipKey", "member",
                "LDAP attribute name on the " + "group object that contains the list of distinguished names\n" + "for the user, group, and contact " +
                        "objects" + " that are members of the group" + ".\n" + "For example: member, uniqueMember or memberUid"),
        HIVE_SERVER2_PLAIN_LDAP_USERMEMBERSHIP_KEY(HIVE_SERVER2_AUTHENTICATION_LDAP_USERMEMBERSHIPKEY_NAME, null, "LDAP attribute name on the user "
                + "object that contains groups of which the user is\n" + "a direct member, except for the primary group, which is represented by the\n" +
                "primaryGroupId.\n" + "For example: memberOf"),
        HIVE_SERVER2_PLAIN_LDAP_GROUPCLASS_KEY("hive.server2.authentication.ldap.groupClassKey", "groupOfNames", "LDAP attribute name on the group "
                + "entry that is to be used in LDAP group searches.\n" + "For example: group, groupOfNames or groupOfUniqueNames."),
        HIVE_SERVER2_PLAIN_LDAP_CUSTOMLDAPQUERY("hive.server2.authentication.ldap.customLDAPQuery", null, "A full LDAP query that LDAP Atn " +
                "provider" + " uses to execute against LDAP Server.\n" + "If this query returns a null resultset, the LDAP Provider fails the " +
                "Authentication\n" + "request, " + "succeeds if the user is part of the resultset." + "For example: (&(objectClass=group)" + "(objectClass" +
                "=top)(instanceType=4)" + "(cn=Domain*)) \n" + "(&(objectClass=person)(|(sAMAccountName=admin)(|(memberOf=CN=Domain Admins," + "CN=Users," +
                "DC=domain,DC=com)" + "(memberOf" + "=CN=Administrators,CN=Builtin,DC=domain,DC=com))))"),
        HIVE_SERVER2_CUSTOM_AUTHENTICATION_CLASS("hive.server2.custom.authentication.class", null, "Custom authentication class. Used when " +
        ...
        HIVE_SERVER2_PAM_SERVICES("hive.server2.authentication.pam.services", null,
                "List of the underlying pam services that should be used when " + "auth type is PAM\n" + "A file with the same name must exist in " +
                        "/etc/pam" + ".d"),
        
        HIVE_SERVER2_ENABLE_DOAS("hive.server2.enable.doAs", true, "Setting this property to true will have HiveServer2 execute\n" + "Hive " +
                "operations as the user making the calls to it."),
        HIVE_SERVER2_TABLE_TYPE_MAPPING("hive.server2.table.type.mapping", "CLASSIC", new StringSet("CLASSIC", "HIVE"), "This setting reflects how "
                + "HiveServer2 will report the table types for JDBC and other\n" + "client implementations that retrieve the available tables and " +
        ...
        HIVE_ALLOW_UDF_LOAD_ON_DEMAND("hive.allow.udf.load.on.demand", false, "Whether enable loading UDFs from metastore on demand; this is " +
                "mostly" + " relevant for\n" + "HS2 and was the default behavior before Hive 1.2. Off by default."),
        
        HIVE_SERVER2_SESSION_CHECK_INTERVAL("hive.server2.session.check.interval", "6h", new TimeValidator(TimeUnit.MILLISECONDS, 3000l, true, null
                , false), "The check interval for session/operation timeout, which can be disabled by setting to zero or negative value."),
        HIVE_SERVER2_CLOSE_SESSION_ON_DISCONNECT("hive.server2.close.session.on.disconnect", true, "Session will be closed when connection is " +
                "closed. Set this to false to have session outlive its parent connection."),
        HIVE_SERVER2_IDLE_SESSION_TIMEOUT("hive.server2.idle.session.timeout", "7d", new TimeValidator(TimeUnit.MILLISECONDS),
        ...
        HIVE_SERVER2_IDLE_OPERATION_TIMEOUT("hive.server2.idle.operation.timeout", "5d", new TimeValidator(TimeUnit.MILLISECONDS), "Operation will "
                + "be closed when it's not accessed for this duration of time, which can be disabled by setting to zero value.\n" + "  With positive " +
        ...
        HIVE_SERVER2_IDLE_SESSION_CHECK_OPERATION("hive.server2.idle.session.check.operation", true,
                "Session will be considered to be idle only " + "if" + " there is no activity, and there is no pending operation.\n" + " This setting " +
                        "takes effect only if session idle timeout (hive" + ".server2" + ".idle.session.timeout) and checking\n" + "(hive.server2.session.check" +
                        ".interval) are enabled."),
        HIVE_SERVER2_THRIFT_CLIENT_RETRY_LIMIT("hive.server2.thrift.client.retry.limit", 1, "Number of retries upon " + "failure of Thrift " +
                "HiveServer2 calls"),
        HIVE_SERVER2_THRIFT_CLIENT_CONNECTION_RETRY_LIMIT("hive.server2.thrift.client.connect.retry.limit", 1, "Number of " + "retries while " +
                "opening a connection to HiveServe2"),
        HIVE_SERVER2_THRIFT_CLIENT_RETRY_DELAY_SECONDS("hive.server2.thrift.client.retry.delay.seconds", "1s", new TimeValidator(TimeUnit.SECONDS),
                "Number of seconds for the HiveServer2 thrift client to wait between " + "consecutive connection attempts. Also specifies the time to " +
                        "wait" + " between retrying thrift calls upon failures"),
        ...
        HIVE_SERVER2_THRIFT_RESULTSET_SERIALIZE_IN_TASKS("hive.server2.thrift.resultset.serialize.in.tasks", false,
                "Whether we should serialize " + "the Thrift structures used in JDBC ResultSet RPC in task nodes.\n " + "We use SequenceFile and " +
                        "ThriftJDBCBinarySerDe to read and write " + "the final results if this is true."),
        // TODO: Make use of this config to configure fetch size
        HIVE_SERVER2_THRIFT_RESULTSET_MAX_FETCH_SIZE("hive.server2.thrift.resultset.max.fetch.size", 10000,
                "Max number of rows sent in one Fetch " + "RPC call by the server to the client."),
        HIVE_SERVER2_THRIFT_RESULTSET_DEFAULT_FETCH_SIZE("hive.server2.thrift.resultset.default.fetch.size", 1000, "The number of rows sent in one "
                + "Fetch RPC call by the server to the client, if not\n" + "specified by the client."),
        ...
        HIVE_SERVER2_JOB_CREDENTIAL_PROVIDER_PATH("hive.server2.job.credential.provider.path", "", "If set, this configuration property should " +
                "provide a comma-separated list of URLs that indicates the type and " + "location of providers to be used by hadoop credential provider " + "API. It provides HiveServer2 the ability to provide job-specific " + "credential providers for jobs run using MR and Spark execution " + "engines. This functionality has not been tested against Tez."),
        ...
        HIVE_LOAD_DYNAMIC_PARTITIONS_THREAD_COUNT("hive.load.dynamic.partitions.thread", 15, new SizeValidator(1L, true, 1024L, true),
        ...
        HIVE_MULTI_INSERT_MOVE_TASKS_SHARE_DEPENDENCIES("hive.multi.insert.move.tasks.share.dependencies", false,
                "If this is set all move tasks " + "for tables/partitions (not directories) at the end of a\n" + "multi-insert query will only begin once "
                        + "the dependencies for all these move" + " tasks have been\n" + "met.\n" + "Advantages: If concurrency is enabled, the locks will only " +
                        "be " + "released once the query has\n" + "      " + " " + "     finished, so with this config enabled, the time when the " +
                        "table/partition is\n" + "            generated will be much closer to " + "when" + " the lock on it is released.\n" + "Disadvantages: " +
                        "If concurrency is not enabled, with this disabled, the tables/partitions " + "which\n" + "               are produced by this query " +
                        "and finish earlier will be available for querying\n" + "               much " + "earlier.  Since " + "the locks are only released " +
                        "once the query finishes, this\n" + "               does not apply if concurrency is " + "enabled."),
        
        HIVE_INFER_BUCKET_SORT("hive.exec.infer.bucket.sort", false, "If this is set, when writing partitions, the metadata will include the " +
        ...
        HIVE_INFER_BUCKET_SORT_NUM_BUCKETS_POWER_TWO("hive.exec.infer.bucket.sort.num.buckets.power.two", false, "If this is set, when setting the "
                + "number of reducers for the map reduce task which writes the\n" + "final output files, it will choose a number which is a power of two, "
                + "unless the user specifies\n" + "the number of reducers to use using mapred.reduce.tasks.  The number of reducers\n" + "may be set to " +
                "a" + " " + "power of two, only to be followed by a merge task meaning preventing\n" + "anything from being inferred.\n" + "With hive" +
                ".exec" + ".infer" + ".bucket.sort set to true:\n" + "Advantages:  If this is not set, the number of buckets for partitions will seem " +
                ...
                "power of two, the " + "number of mappers used for " + "optimized joins" + " will be the least\n" + "             number of buckets " +
                "used by any partition " + "being joined.\n" + "Disadvantages: " + "This may mean a much " + "larger or much smaller number of " +
        ...
        SERVER_TCP_KEEP_ALIVE("hive.server.tcp.keepalive", true, "Whether to enable TCP keepalive for the Hive Server. Keepalive will prevent " +
         ...
         *  注释： 执行引擎配置
         */
        HIVE_EXECUTION_ENGINE("hive.execution.engine", "mr", new StringSet("mr",
                "tez", "spark"),
                "Chooses execution engine. Options are: mr (Map " + "reduce, default), tez, spark. While MR\n" + "remains the default engine for " +
                        "historical reasons, it is itself a historical engine\n" + "and is " + "deprecated in Hive 2 line. It may be removed without further " +
                        "warning."),
        ...
        HIVE_USER_INSTALL_DIR("hive.user.install.directory", "/user/", "If hive (in tez mode only) cannot find a usable hive jar in \"hive.jar" +
                ".directory\", \n" + "it will upload the hive jar to \"hive.user.install.directory/user.name\"\n" + "and use it to run queries."),
        
        // Vectorization enabled
        HIVE_VECTORIZATION_ENABLED("hive.vectorized.execution.enabled", false, "This flag should be set to true to enable vectorized mode of query "
        ...
        HIVE_VECTORIZATION_MAPJOIN_NATIVE_MULTIKEY_ONLY_ENABLED("hive.vectorized.execution.mapjoin.native.multikey.only.enabled", false, "This " +
                "flag" + " should be set to true to restrict use of native vector map join hash tables to\n" + "the MultiKey in queries using MapJoin.\n" + "The " + "default value is false."),
        HIVE_VECTORIZATION_MAPJOIN_NATIVE_MINMAX_ENABLED("hive.vectorized.execution.mapjoin.minmax.enabled", false,
                "This flag should be set to " + "true to enable vector map join hash tables to\n" + "use max / max filtering for integer join queries " +
                        "using MapJoin.\n" + "The default " + "value is false."),
        HIVE_VECTORIZATION_MAPJOIN_NATIVE_OVERFLOW_REPEATED_THRESHOLD("hive.vectorized.execution.mapjoin.overflow.repeated.threshold", -1,
                "The " + "number of small table rows for a match in vector map join hash tables\n" + "where we use the repeated field optimization in " +
                        "overflow " + "vectorized row batch for join queries using MapJoin.\n" + "A value of -1 means do use the join result optimization.  " +
                        "Otherwise, " + "threshold" + " value can be 0 to maximum integer."),
        ...
        HIVE_VECTORIZATION_GROUPBY_CHECKINTERVAL("hive.vectorized.groupby.checkinterval", 100000, "Number of entries added to the group by " +
                "aggregation hash before a recomputation of average entry size is performed."),
        HIVE_VECTORIZATION_GROUPBY_MAXENTRIES("hive.vectorized.groupby.maxentries", 1000000, "Max number of entries in the vector group by " +
                "aggregation hashtables. \n" + "Exceeding this will trigger a flush irrelevant of memory pressure condition."),
        HIVE_VECTORIZATION_GROUPBY_FLUSH_PERCENT("hive.vectorized.groupby.flush.percent", (float) 0.1, "Percent of entries in the group by " +
                "aggregation hash flushed when the memory threshold is exceeded."),
        HIVE_VECTORIZATION_REDUCESINK_NEW_ENABLED("hive.vectorized.execution.reducesink.new.enabled", true,
                "This flag should be set to true to " + "enable the new vectorization\n" + "of queries using ReduceSink.\ni" + "The default value is true."),
        ...
        HIVE_VECTORIZATION_USE_VECTOR_DESERIALIZE("hive.vectorized.use.vector.serde.deserialize", true, "This flag should be set to true to enable "
                + "vectorizing rows using vector deserialize.\n" + "The default value is true."),
        HIVE_VECTORIZATION_USE_ROW_DESERIALIZE("hive.vectorized.use.row.serde.deserialize", false, "This flag should be set to true to enable " +
                "vectorizing using row deserialize.\n" + "The default value is false."),
        ...
        HIVE_TYPE_CHECK_ON_INSERT("hive.typecheck.on.insert", true,
                "This property has been extended to control " + "whether to check, convert, " + "and" + " normalize partition value to conform to its " +
        ...
        HIVE_TEZ_GENERATE_CONSISTENT_SPLITS("hive.tez.input.generate.consistent.splits", true, "Whether to generate consistent split locations " +
                "when" + " generating splits in the AM"),
        ...
        HIVE_QUOTEDID_SUPPORT("hive.support.quoted.identifiers", "column", new StringSet("none", "column"), "Whether to use quoted identifier. " +
                "'none' or 'column' can be used. \n" + "  none: default(past) behavior. Implies only alphaNumeric and underscore are valid characters in " + "identifiers.\n" + "  column: implies column names can contain any character."),
        HIVE_SUPPORT_SPECICAL_CHARACTERS_IN_TABLE_NAMES("hive.support.special.characters.tablename", true, "This flag should be set to true to " +
                "enable support for special characters in table names.\n" + "When it is set to false, only [a-zA-Z_0-9]+ are supported.\n" + "The only " +
                "supported special character right now is '/'. This flag applies only to quoted table names.\n" + "The default value is true."),
        ...
        HIVE_COMPAT("hive.compat", HiveCompat.DEFAULT_COMPAT_LEVEL, "Enable (configurable) deprecated behaviors by setting desired level of " +
                "backward compatibility.\n" + "Setting to 0.12:\n" + "  Maintains division behavior: int / int = double"),
        HIVE_CONVERT_JOIN_BUCKET_MAPJOIN_TEZ("hive.convert.join.bucket.mapjoin.tez", false, "Whether joins can be automatically converted to " +
                "bucket" + " map joins in hive \n" + "when tez is used as the execution engine."),
        
        HIVE_CHECK_CROSS_PRODUCT("hive.exec.check.crossproducts", true, "Check if a plan contains a Cross Product. If there is one, output a " +
                "warning to the Session's console."),
        ...
        TEZ_AUTO_REDUCER_PARALLELISM("hive.tez.auto.reducer.parallelism", false, "Turn on Tez' auto reducer parallelism feature. When enabled, " +
                "Hive" + " will still estimate data sizes\n" + "and set parallelism estimates. Tez will sample source vertices' output sizes and adjust " + "the " + "estimates at runtime as\n" + "necessary."),
        TEZ_MAX_PARTITION_FACTOR("hive.tez.max.partition.factor", 2f, "When auto reducer parallelism is enabled this factor will be used to " +
                "over" + "-partition data in shuffle edges."),
        TEZ_MIN_PARTITION_FACTOR("hive.tez.min.partition.factor", 0.25f, "When auto reducer parallelism is enabled this factor will be used to put "
                + "a lower limit to the number\n" + "of reducers that tez specifies."),
        TEZ_OPTIMIZE_BUCKET_PRUNING("hive.tez.bucket.pruning", false,
        ...
        TEZ_OPTIMIZE_BUCKET_PRUNING_COMPAT("hive.tez.bucket.pruning.compat", true, "When pruning is enabled, handle possibly broken inserts due to "
                + "negative hashcodes.\n" + "This occasionally doubles the data scan cost, but is default enabled for safety"),
        TEZ_DYNAMIC_PARTITION_PRUNING("hive.tez.dynamic.partition.pruning", true,
                "When dynamic pruning is enabled, joins on partition keys will " + "be" + " processed by sending\n" + "events from the processing vertices" +
                        " to the Tez application master. These events will be\n" + "used to " + "prune " + "unnecessary partitions."),
        TEZ_DYNAMIC_PARTITION_PRUNING_MAX_EVENT_SIZE("hive.tez.dynamic.partition.pruning.max.event.size", 1 * 1024 * 1024L, "Maximum size of " +
                "events" + " sent by processors in dynamic pruning. If this size is crossed no pruning will take place."),
        ...
        TEZ_DYNAMIC_SEMIJOIN_REDUCTION("hive.tez.dynamic.semijoin.reduction", true,
                "When dynamic semijoin is enabled, shuffle joins will perform " + "a" + " leaky semijoin before shuffle. This " + "requires hive.tez" +
                        ".dynamic.partition.pruning to be enabled."),
        ...
        TEZ_MAX_BLOOM_FILTER_ENTRIES("hive.tez.max.bloom.filter.entries", 100000000L, "Bloom filter should be of at max certain size to be " +
                "effective"),
        TEZ_BLOOM_FILTER_FACTOR("hive.tez.bloom.filter.factor", (float) 2.0, "Bloom filter should be a multiple of this factor with nDV"),
        TEZ_BIGTABLE_MIN_SIZE_SEMIJOIN_REDUCTION("hive.tez.bigtable.minsize.semijoin.reduction", 1000000L, "Big table for runtime filteting should "
                + "be of atleast this size"),
        TEZ_DYNAMIC_SEMIJOIN_REDUCTION_THRESHOLD("hive.tez.dynamic.semijoin.reduction.threshold", (float) 0.50, "Only perform semijoin " +
                "optimization" + " if the estimated benefit at or above this fraction of the target table"),
        TEZ_SMB_NUMBER_WAVES("hive.tez.smb.number.waves", (float) 0.5, "The number of waves in which to run the SMB join. Account for cluster " +
                "being" + " occupied. Ideally should be 1 wave."),
        ...
        TEZ_EXEC_INPLACE_PROGRESS("hive.tez.exec.inplace.progress", true, "Updates tez job execution progress in-place in the terminal when " +
                "hive" + "-cli is used."),
        HIVE_SERVER2_INPLACE_PROGRESS("hive.server2.in.place.progress", true,
        ...
        TEZ_CONTAINER_MAX_JAVA_HEAP_FRACTION("hive.tez.container.max.java.heap.fraction", 0.8f, "This is to override the tez setting with the same "
                + "name"),
        TEZ_TASK_SCALE_MEMORY_RESERVE_FRACTION_MIN("hive.tez.task.scale.memory.reserve-fraction.min", 0.3f,
                "This is to override the tez setting " + "tez.task.scale.memory.reserve-fraction"),
        TEZ_TASK_SCALE_MEMORY_RESERVE_FRACTION_MAX("hive.tez.task.scale.memory.reserve.fraction.max", 0.5f,
                "The maximum fraction of JVM memory " + "which Tez will reserve for the processor"),
        TEZ_TASK_SCALE_MEMORY_RESERVE_FRACTION("hive.tez.task.scale.memory.reserve.fraction", -1f,
        ...
        LLAP_IO_NONVECTOR_WRAPPER_ENABLED("hive.llap.io.nonvector.wrapper.enabled", true, "Whether the LLAP IO layer is enabled for non-vectorized "
                + "queries that read inputs\n" + "that can be vectorized"),
        LLAP_IO_MEMORY_MODE("hive.llap.io.memory.mode", "cache", new StringSet("cache", "none"), "LLAP IO memory usage; 'cache' (the default) uses "
                + "data and metadata cache with a\n" + "custom off-heap allocator, 'none' doesn't use either (this mode may result in\n" + "significant " + "performance degradation)"),
        LLAP_ALLOCATOR_MIN_ALLOC("hive.llap.io.allocator.alloc.min", "256Kb", new SizeValidator(),
                "Minimum allocation possible from LLAP buddy " + "allocator. Allocations below that are\n" + "padded to minimum allocation. For ORC, " +
                        "should generally be the same as the expected\n" + "compression buffer size, or next lowest power of 2. Must be a power of 2."),
        LLAP_ALLOCATOR_MAX_ALLOC("hive.llap.io.allocator.alloc.max", "16Mb", new SizeValidator(), "Maximum allocation possible from LLAP buddy " +
                "allocator. For ORC, should be as large as\n" + "the largest expected ORC compression buffer size. Must be a power of 2."),
        @Deprecated LLAP_IO_METADATA_FRACTION("hive.llap.io.metadata.fraction", 0.1f,
                "Temporary setting for on-heap metadata cache fraction of " + "xmx, set to avoid potential\n" + "heap problems on very large datasets " +
                        "when" + " on-heap metadata cache takes over\n" + "everything. -1 " + "managed metadata and data together (which is more flexible). " +
        ...
        LLAP_IO_MEMORY_MAX_SIZE("hive.llap.io.memory.size", "1Gb", new SizeValidator(), "Maximum size for IO allocator or ORC low-level cache.",
        ...
        LLAP_ALLOCATOR_MAPPED_PATH("hive.llap.io.allocator.mmap.path", "/tmp", new WritableDirectoryValidator(), "The directory location for " +
        ...
        LLAP_IO_ENCODE_ENABLED("hive.llap.io.encode.enabled", true, "Whether LLAP should try to re-encode and cache data for non-ORC formats. This "
                + "is used\n" + "on LLAP Server side to determine if the infrastructure for that is initialized."),
        LLAP_IO_ENCODE_FORMATS("hive.llap.io.encode.formats", "org.apache.hadoop.mapred.TextInputFormat,", "The table input formats for which LLAP "
                + "IO should re-encode and cache data.\n" + "Comma-separated list."),
        ...
        LLAP_IO_ENCODE_VECTOR_SERDE_ASYNC_ENABLED("hive.llap.io.encode.vector.serde.async.enabled", true,
                "Whether LLAP should use async mode in " + "vectorized SerDe reader to read text data."),
        LLAP_IO_ENCODE_SLICE_ROW_COUNT("hive.llap.io.encode.slice.row.count", 100000, "Row count to use to separate cache slices when reading " +
                "encoded data from row-based\n" + "inputs into LLAP cache, if this feature is enabled."),
        LLAP_IO_ENCODE_SLICE_LRR("hive.llap.io.encode.slice.lrr", true, "Whether to separate cache slices when reading encoded data from text " +
        ...
        LLAP_AUTO_MAX_OUTPUT("hive.llap.auto.max.output.size", 1 * 1024 * 1024 * 1024L, "Check output size, before considering vertex (-1 disables "
                + "check)"),
        LLAP_SKIP_COMPILE_UDF_CHECK("hive.llap.skip.compile.udf.check", false,
                "Whether to skip the compile-time check for non-built-in UDFs when " + "deciding whether to\n" + "execute tasks in LLAP. Skipping the " +
                        "check allows executing UDFs from pre-localized\n" + "jars in LLAP; if the " + "jars are not pre-localized, the UDFs will simply fail to " + "load."),
        LLAP_ALLOW_PERMANENT_FNS("hive.llap.allow.permanent.fns", true, "Whether LLAP decider should allow permanent UDFs."),
        LLAP_EXECUTION_MODE("hive.llap.execution.mode", "none", new StringSet("auto", "none", "all", "map", "only"), "Chooses whether query " +
                "fragments will run in container or in llap"),
        LLAP_OBJECT_CACHE_ENABLED("hive.llap.object.cache.enabled", true, "Cache objects (plans, hashtables, etc) in llap"),
        LLAP_IO_DECODING_METRICS_PERCENTILE_INTERVALS("hive.llap.io.decoding.metrics.percentiles.intervals", "30", "Comma-delimited set of " +
        ...
        LLAP_KERBEROS_PRINCIPAL(HIVE_LLAP_DAEMON_SERVICE_PRINCIPAL_NAME, "", "The name of the LLAP daemon's service principal."),
        ...
        LLAP_ZKSM_KERBEROS_PRINCIPAL("hive.llap.zk.sm.principal", "", "The name of the principal to use to talk to ZooKeeper for ZooKeeper " +
                "SecretManager."),
        LLAP_ZKSM_KERBEROS_KEYTAB_FILE("hive.llap.zk.sm.keytab.file", "", "The path to the Kerberos Keytab file containing the principal to use to "
                + "talk to\n" + "ZooKeeper for ZooKeeper SecretManager."),
        LLAP_WEBUI_SPNEGO_KEYTAB_FILE("hive.llap.webui.spnego.keytab", "",
                "The path to the Kerberos Keytab file containing the LLAP WebUI SPNEGO " + "principal.\n" + "Typical value would look like " + "/etc" +
        ...
        LLAP_ZK_REGISTRY_NAMESPACE("hive.llap.zk.registry.namespace", null,
                "In the LLAP ZooKeeper-based registry, overrides the ZK path namespace" + "." + " Note that\n" + "using this makes the path management (e" +
                        ".g. setting correct ACLs) your responsibility."),
        ...
        LLAP_REMOTE_TOKEN_REQUIRES_SIGNING("hive.llap.remote.token.requires.signing", "true", new StringSet("false", "except_llap_owner", "true"),
        ...
        LLAP_DELEGATION_TOKEN_LIFETIME("hive.llap.daemon.delegation.token.lifetime", "14d", new TimeValidator(TimeUnit.SECONDS),
        ...
        LLAP_DAEMON_RPC_NUM_HANDLERS("hive.llap.daemon.rpc.num.handlers", 5, "Number of RPC handlers for LLAP daemon.", "llap.daemon.rpc.num" +
                ".handlers"),
        ...
        LLAP_DAEMON_YARN_SHUFFLE_PORT("hive.llap.daemon.yarn.shuffle.port", 15551, "YARN shuffle port for LLAP-daemon-hosted shuffle.", "llap" +
                ".daemon.yarn.shuffle.port"),
        ...
        LLAP_DAEMON_CONTAINER_ID("hive.llap.daemon.container.id", null, "ContainerId of a running LlapDaemon. Used to publish to the registry"),
        LLAP_DAEMON_NM_ADDRESS("hive.llap.daemon.nm.address", null, "NM Address host:rpcPort for the NodeManager on which the instance of the " +
                "daemon is running.\n" + "Published to the llap registry. Should never be set by users"),
        LLAP_DAEMON_SHUFFLE_DIR_WATCHER_ENABLED("hive.llap.daemon.shuffle.dir.watcher.enabled", false, "TODO doc", "llap.daemon.shuffle" + ".dir" +
                "-watcher" + ".enabled"),
        LLAP_DAEMON_AM_LIVENESS_HEARTBEAT_INTERVAL_MS("hive.llap.daemon.am.liveness.heartbeat.interval.ms", "10000ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Tez AM-LLAP heartbeat interval (milliseconds). This needs to be below the task timeout\n" +
                "interval, but otherwise as high as possible to avoid unnecessary traffic.", "llap.daemon.am.liveness.heartbeat.interval-ms"),
        LLAP_DAEMON_AM_LIVENESS_CONNECTION_TIMEOUT_MS("hive.llap.am.liveness.connection.timeout.ms", "10000ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Amount of time to wait on connection failures to the AM from an LLAP daemon before\n" +
        ...
        LLAP_DAEMON_AM_LIVENESS_CONNECTION_SLEEP_BETWEEN_RETRIES_MS("hive.llap.am.liveness.connection.sleep.between.retries.ms", "2000ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Sleep duration while waiting to retry connection failures to the AM from the daemon for\n" +
                "the " + "general keep-alive thread (milliseconds).", "llap.am.liveness.connection.sleep-between-retries-millis"),
        LLAP_DAEMON_TASK_SCHEDULER_TIMEOUT_SECONDS("hive.llap.task.scheduler.timeout.seconds", "60s", new TimeValidator(TimeUnit.SECONDS), "Amount "
                + "of time to wait before failing the query when there are no llap daemons running\n" + "(alive) in the cluster.",
                "llap.daemon.scheduler" + ".timeout.seconds"),
        LLAP_DAEMON_NUM_EXECUTORS("hive.llap.daemon.num.executors", 4, "Number of executors to use in LLAP daemon; essentially, the number of " +
        ...
        LLAP_DAEMON_MEMORY_PER_INSTANCE_MB("hive.llap.daemon.memory.per.instance.mb", 4096,
                "The total amount of memory to use for the executors " + "inside LLAP (in megabytes).", "llap.daemon.memory.per.instance.mb"),
        LLAP_DAEMON_XMX_HEADROOM("hive.llap.daemon.xmx.headroom", "5%", "The total amount of heap memory set aside by LLAP and not used by the " +
        ...
        LLAP_DAEMON_VCPUS_PER_INSTANCE("hive.llap.daemon.vcpus.per.instance", 4, "The total number of vcpus to use for the executors inside LLAP.",
                "llap.daemon.vcpus.per.instance"),
        LLAP_DAEMON_NUM_FILE_CLEANER_THREADS("hive.llap.daemon.num.file.cleaner.threads", 1, "Number of file cleaner threads in LLAP.", "llap" +
                ".daemon.num.file.cleaner.threads"),
        LLAP_FILE_CLEANUP_DELAY_SECONDS("hive.llap.file.cleanup.delay.seconds", "300s", new TimeValidator(TimeUnit.SECONDS),
                "How long to delay " + "before cleaning up query files in LLAP (in seconds, for debugging).", "llap.file.cleanup.delay-seconds"),
        LLAP_DAEMON_SERVICE_HOSTS("hive.llap.daemon.service.hosts", null, "Explicitly specified hosts to use for LLAP scheduling. Useful for " +
                "testing. By default,\n" + "YARN registry is used.", "llap.daemon.service.hosts"),
        LLAP_DAEMON_SERVICE_REFRESH_INTERVAL("hive.llap.daemon.service.refresh.interval.sec", "60s", new TimeValidator(TimeUnit.SECONDS),
                "LLAP " + "YARN registry service list refresh delay, in seconds.", "llap.daemon.service.refresh.interval"),
        LLAP_DAEMON_COMMUNICATOR_NUM_THREADS("hive.llap.daemon.communicator.num.threads", 10,
                "Number of threads to use in LLAP task communicator " + "in Tez AM.", "llap.daemon.communicator.num.threads"),
        ...
        LLAP_TASK_SCHEDULER_NODE_REENABLE_MIN_TIMEOUT_MS("hive.llap.task.scheduler.node.reenable.min.timeout.ms", "200ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Minimum time after which a previously disabled node will be re-enabled for scheduling,\n" + "in"
                + " milliseconds. This may be modified by an exponential back-off if failures persist.",
                "llap.task.scheduler.node.re-enable.min.timeout" + ".ms"),
        LLAP_TASK_SCHEDULER_NODE_REENABLE_MAX_TIMEOUT_MS("hive.llap.task.scheduler.node.reenable.max.timeout.ms", "10000ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Maximum time after which a previously disabled node will be re-enabled for scheduling,\n" + "in"
                + " milliseconds. This may be modified by an exponential back-off if failures persist.",
                "llap.task.scheduler.node.re-enable.max.timeout" + ".ms"),
        LLAP_TASK_SCHEDULER_NODE_DISABLE_BACK_OFF_FACTOR("hive.llap.task.scheduler.node.disable.backoff.factor", 1.5f, "Backoff factor on " +
                "successive blacklists of a node due to some failures. Blacklist times\n" + "start at the min timeout and go up to the max timeout based " + "on this backoff factor.", "llap.task.scheduler.node.disable.backoff.factor"),
        LLAP_TASK_SCHEDULER_NUM_SCHEDULABLE_TASKS_PER_NODE("hive.llap.task.scheduler.num.schedulable.tasks.per.node", 0,
                "The number of tasks the " + "AM TaskScheduler will try allocating per node. 0 indicates that\n" + "this should be picked up from the " +
                        "Registry. -1 indicates unlimited " + "capacity; positive\n" + "values indicate a specific bound.",
                "llap.task.scheduler.num.schedulable" + ".tasks.per.node"),
        LLAP_TASK_SCHEDULER_LOCALITY_DELAY("hive.llap.task.scheduler.locality.delay", "0ms", new TimeValidator(TimeUnit.MILLISECONDS, -1l, true,
                Long.MAX_VALUE, true),
                "Amount of time to wait before allocating a request which contains location information," + " to a location other " + "than the ones " +
                        "requested. Set to -1 for an infinite delay, 0" + "for no delay."),
        LLAP_DAEMON_TASK_PREEMPTION_METRICS_INTERVALS("hive.llap.daemon.task.preemption.metrics.intervals", "30,60,300",
                "Comma-delimited set of " + "integers denoting the desired rollover intervals (in seconds)\n" + " for percentile latency metrics. Used by "
                        + "LLAP daemon task scheduler " + "metrics for\n" + " time taken to kill task (due to pre-emption) and useful time wasted by the task " + "that\n" + " is about to be preempted."),
        LLAP_DAEMON_TASK_SCHEDULER_WAIT_QUEUE_SIZE("hive.llap.daemon.task.scheduler.wait.queue.size", 10, "LLAP scheduler maximum queue size.",
                "llap" + ".daemon.task.scheduler.wait.queue.size"),
        LLAP_DAEMON_WAIT_QUEUE_COMPARATOR_CLASS_NAME("hive.llap.daemon.wait.queue.comparator.class.name",
                "org.apache.hadoop.hive.llap.daemon.impl" + ".comparator.ShortestJobFirstComparator",
                "The priority comparator to use for LLAP scheduler " + "prioroty queue. The built-in options\n" + "are org" + ".apache.hadoop.hive.llap" +
                        ".daemon.impl.comparator.ShortestJobFirstComparator and\n" + ".....FirstInFirstOutComparator", "llap.daemon" + ".wait" + ".queue" +
                ".comparator.class.name"),
        LLAP_DAEMON_TASK_SCHEDULER_ENABLE_PREEMPTION("hive.llap.daemon.task.scheduler.enable.preemption", true,
        ...
        LLAP_TASK_COMMUNICATOR_CONNECTION_TIMEOUT_MS("hive.llap.task.communicator.connection.timeout.ms", "16000ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Connection timeout (in milliseconds) before a failure to an LLAP daemon from Tez AM.",
                "llap" + ".task.communicator.connection.timeout-millis"),
        LLAP_TASK_COMMUNICATOR_LISTENER_THREAD_COUNT("hive.llap.task.communicator.listener.thread-count", 30, "The number of task communicator " +
                "listener threads."),
        LLAP_TASK_COMMUNICATOR_CONNECTION_SLEEP_BETWEEN_RETRIES_MS("hive.llap.task.communicator.connection.sleep.between.retries.ms", "2000ms",
                new TimeValidator(TimeUnit.MILLISECONDS), "Sleep duration (in milliseconds) to wait before retrying on error when obtaining a\n" +
        ...
        LLAP_VALIDATE_ACLS("hive.llap.validate.acls", true,
                "Whether LLAP should reject permissive ACLs in some cases (e.g. its own management\n" + "protocol or ZK paths), similar to how ssh " +
                        "refuses" + " a key with bad access permissions."),
        LLAP_DAEMON_OUTPUT_SERVICE_PORT("hive.llap.daemon.output.service.port", 15003, "LLAP daemon output service port"),
        LLAP_DAEMON_OUTPUT_STREAM_TIMEOUT("hive.llap.daemon.output.stream.timeout", "120s", new TimeValidator(TimeUnit.SECONDS),
        ...
        LLAP_DAEMON_OUTPUT_SERVICE_SEND_BUFFER_SIZE("hive.llap.daemon.output.service.send.buffer.size", 128 * 1024,
                "Send buffer size to be used " + "by" + " LLAP daemon output service"),
        LLAP_DAEMON_OUTPUT_SERVICE_MAX_PENDING_WRITES("hive.llap.daemon.output.service.max.pending.writes", 8,
        ...
        LLAP_HS2_ENABLE_COORDINATOR("hive.llap.hs2.coordinator.enabled", true, "Whether to create the LLAP coordinator; since execution engine and "
        ...
        LLAP_DAEMON_LOGGER("hive.llap.daemon.logger", Constants.LLAP_LOGGER_NAME_QUERY_ROUTING,
                new StringSet(Constants.LLAP_LOGGER_NAME_QUERY_ROUTING, Constants.LLAP_LOGGER_NAME_RFA, Constants.LLAP_LOGGER_NAME_CONSOLE), "logger used "
                + "for llap-daemons."),
        
        SPARK_USE_OP_STATS("hive.spark.use.op.stats", true, "Whether to use operator stats to determine reducer parallelism for Hive on Spark. " +
                "If " + "this is false, Hive will use source table stats to determine reducer " + "parallelism for all first level reduce tasks, and the " + "maximum" + " " + "reducer parallelism " + "from all parents for all the rest (second level and onward) reducer tasks."),
        SPARK_USE_FILE_SIZE_FOR_MAPJOIN("hive.spark.use.file.size.for.mapjoin", false, "If this is set to true, mapjoin optimization in Hive/Spark "
                + "will use source file sizes associated " + "with TableScan operator on the root of operator tree, instead of using operator statistics."),
        SPARK_CLIENT_FUTURE_TIMEOUT("hive.spark.client.future.timeout", "60s", new TimeValidator(TimeUnit.SECONDS), "Timeout for requests from " +
                "Hive" + " client to remote Spark driver."),
        SPARK_JOB_MONITOR_TIMEOUT("hive.spark.job.monitor.timeout", "60s", new TimeValidator(TimeUnit.SECONDS),
                "Timeout for job monitor to get " + "Spark job state."),
        SPARK_RPC_CLIENT_CONNECT_TIMEOUT("hive.spark.client.connect.timeout", "1000ms", new TimeValidator(TimeUnit.MILLISECONDS), "Timeout for " +
                "remote Spark driver in connecting back to Hive client."),
        SPARK_RPC_CLIENT_HANDSHAKE_TIMEOUT("hive.spark.client.server.connect.timeout", "90000ms", new TimeValidator(TimeUnit.MILLISECONDS),
                "Timeout " + "for handshake between Hive client and remote Spark driver.  Checked by both processes."),
        SPARK_RPC_SECRET_RANDOM_BITS("hive.spark.client.secret.bits", "256", "Number of bits of randomness in the generated secret for " +
                "communication between Hive client and remote Spark driver. " + "Rounded down to the nearest multiple of 8."),
        ...
        SPARK_RPC_SERVER_ADDRESS("hive.spark.client.rpc.server.address", "", "The server address of HiverServer2 host to be used for communication "
                + "between Hive client and remote Spark driver. " + "Default is empty, which means the address will be determined in the same way as for " + "hive.server2.thrift.bind.host." + "This is only necessary if the host has mutiple network addresses and if a different network address " + "other than " + "hive.server2.thrift.bind.host is to be used."),
        SPARK_RPC_SERVER_PORT("hive.spark.client.rpc.server.port", "", "A list of port ranges which can be used by RPC server " + "with the format "
                + "of 49152-49222,49228 and a random one is selected from the list. Default is empty, which randomly " + "selects one port from all " +
                "available ones."),
        SPARK_DYNAMIC_PARTITION_PRUNING("hive.spark.dynamic.partition.pruning", false,
                "When dynamic pruning is enabled, joins on partition keys " + "will be processed by writing\n" + "to a temporary HDFS file, and read " +
                        "later" + " for removing unnecessary partitions."),
        SPARK_DYNAMIC_PARTITION_PRUNING_MAX_DATA_SIZE("hive.spark.dynamic.partition.pruning.max.data.size", 100 * 1024 * 1024L, "Maximum total " +
        ...
        HIVE_MSCK_PATH_VALIDATION("hive.msck.path.validation", "throw", new StringSet("throw", "skip", "ignore"),
        ...
        HIVE_MSCK_REPAIR_BATCH_SIZE("hive.msck.repair.batch.size", 0,
                "Batch size for the msck repair command. If the value is greater than zero, " + "it will execute batch wise with the configured batch " +
                        "size" + ". " + "The default value is zero. Zero means it will execute directly (Not batch" + " wise)"),
        HIVE_SERVER2_LLAP_CONCURRENT_QUERIES("hive.server2.llap.concurrent.queries", -1, "The number of queries allowed in parallel via llap. " +
                "Negative number implies 'infinite'."),
        HIVE_TEZ_ENABLE_MEMORY_MANAGER("hive.tez.enable.memory.manager", true, "Enable memory manager for tez"),
        HIVE_HASH_TABLE_INFLATION_FACTOR("hive.hash.table.inflation.factor", (float) 2.0, "Expected inflation factor between disk/in memory " +
                "representation of hash tables"),
        HIVE_LOG_TRACE_ID("hive.log.trace.id", "", "Log tracing id that can be used by upstream clients for tracking respective logs. " +
                "Truncated to" + " " + LOG_PREFIX_LENGTH + " characters. Defaults to use auto-generated session id."),
        
        HIVE_CONF_RESTRICTED_LIST("hive.conf.restricted.list",
                "hive.security.authenticator.manager,hive.security.authorization.manager," + "hive" + ".security.metastore.authorization.manager,hive" +
                        ".security.metastore.authenticator.manager," + "hive.users.in.admin.role,hive.server2.xsrf" + ".filter.enabled,hive.security" +
                        ".authorization.enabled," + "hive.server2.authentication.ldap.baseDN," + "hive.server2.authentication.ldap" + ".url," + "hive.server2" +
                        ".authentication.ldap.Domain," + "hive.server2.authentication.ldap.groupDNPattern," + "hive.server2.authentication" + ".ldap" +
                        ".groupFilter," + "hive.server2.authentication.ldap.userDNPattern," + "hive.server2.authentication.ldap.userFilter," + "hive" + ".server2" + ".authentication.ldap.groupMembershipKey," + "hive.server2.authentication.ldap.userMembershipKey," + "hive.server2" + ".authentication.ldap" + ".groupClassKey," + "hive.server2.authentication.ldap.customLDAPQuery", "Comma separated list of " + "configuration " + "options which are " + "immutable at runtime"),
        HIVE_CONF_HIDDEN_LIST("hive.conf.hidden.list", METASTOREPWD.varname + "," + HIVE_SERVER2_SSL_KEYSTORE_PASSWORD.varname
                // Adding the S3 credentials from Hadoop config to be hidden
                + ",fs.s3.awsAccessKeyId" + ",fs.s3.awsSecretAccessKey" + ",fs.s3n.awsAccessKeyId" + ",fs.s3n.awsSecretAccessKey" + ",fs.s3a" +
                ".access" + ".key" + ",fs.s3a.secret.key" + ",fs.s3a.proxy.password",
                "Comma separated list of configuration options which should " + "not be read " + "by normal user like passwords"),
        HIVE_CONF_INTERNAL_VARIABLE_LIST("hive.conf.internal.variable.list", "hive.added.files.path,hive.added.jars.path,hive.added.archives.path",
                "Comma separated list of variables which are used internally and should not be configurable."),
        
        HIVE_QUERY_TIMEOUT_SECONDS("hive.query.timeout.seconds", "0s", new TimeValidator(TimeUnit.SECONDS), "Timeout for Running Query in seconds. "
                + "A nonpositive value means infinite. " + "If the query timeout is also set by thrift API call, the smaller one will be taken."),
        
        HIVE_EXEC_INPUT_LISTING_MAX_THREADS("hive.exec.input.listing.max.threads", 0, new SizeValidator(0L, true, 1024L, true), "Maximum number of "
                + "threads that Hive uses to list file information from file systems (recommended > 1 for blobstore)."),
        ...
        HIVE_BLOBSTORE_USE_BLOBSTORE_AS_SCRATCHDIR("hive.blobstore.use.blobstore.as.scratchdir", false, "Enable the use of scratch directories " +
                "directly on blob storage systems (it may cause performance penalties)."),
        
        HIVE_BLOBSTORE_OPTIMIZATIONS_ENABLED("hive.blobstore.optimizations.enabled", true,
                "This parameter enables a number of optimizations when " + "running on blobstores:\n" + "(1) If hive.blobstore.use.blobstore.as" +
                        ".scratchdir" + " is false, force the last Hive job to write to the " + "blobstore.\n" + "This is a performance optimization that forces " +
                        "the final " + "FileSinkOperator to write to the blobstore.\n" + "See " + "HIVE" + "-15121 for details.");
        ...
        ConfVars(
                String varname, Object defaultVal, Validator validator, String description, String altName) {
        ...
        ConfVars(
                String varname, Object defaultVal, Validator validator, String description, boolean caseSensitive, boolean excluded, String altName) {
    ...
    public void verifyAndSet(String name, String value) throws IllegalArgumentException {
        if (modWhiteListPattern != null) {
            ...
            if (!wlMatcher.matches()) {
                throw new IllegalArgumentException("Cannot modify " + name + " at runtime. " + "It is not in list of params that are allowed to be "
                        + "modified at runtime");
            }
        }
        if (restrictList.contains(name)) {
            throw new IllegalArgumentException("Cannot modify " + name + " at runtime. It is in the list" + " of parameters that can't be modified "
                    + "at runtime");
        }
    ...
    public String getLogIdVar(String defaultValue) {
        ...
        if (retval.length() > LOG_PREFIX_LENGTH) {
            l4j.warn("The original log id prefix is " + retval + " has been truncated to " + retval.substring(0, LOG_PREFIX_LENGTH - 1));
    ...
    public static void setVar(
            Configuration conf, ConfVars var, String val, EncoderDecoder<String, String> encoderDecoder) {
     ...
     */
    private static final String[] sqlStdAuthSafeVarNames = new String[]{ConfVars.AGGR_JOIN_TRANSPOSE.varname, ConfVars.BYTESPERREDUCER.varname,
            ConfVars.CLIENT_STATS_COUNTERS.varname, ConfVars.DEFAULTPARTITIONNAME.varname, ConfVars.DROPIGNORESNONEXISTENT.varname,
            ConfVars.HIVECOUNTERGROUP.varname, ConfVars.HIVEDEFAULTMANAGEDFILEFORMAT.varname, ConfVars.HIVEENFORCEBUCKETMAPJOIN.varname,
            ConfVars.HIVEENFORCESORTMERGEBUCKETMAPJOIN.varname, ConfVars.HIVEEXPREVALUATIONCACHE.varname, ConfVars.HIVEQUERYRESULTFILEFORMAT.varname,
            ConfVars.HIVEHASHTABLELOADFACTOR.varname, ConfVars.HIVEHASHTABLETHRESHOLD.varname, ConfVars.HIVEIGNOREMAPJOINHINT.varname,
            ConfVars.HIVELIMITMAXROWSIZE.varname, ConfVars.HIVEMAPREDMODE.varname, ConfVars.HIVEMAPSIDEAGGREGATE.varname,
            ConfVars.HIVEOPTIMIZEMETADATAQUERIES.varname, ConfVars.HIVEROWOFFSET.varname, ConfVars.HIVEVARIABLESUBSTITUTE.varname,
            ConfVars.HIVEVARIABLESUBSTITUTEDEPTH.varname, ConfVars.HIVE_AUTOGEN_COLUMNALIAS_PREFIX_INCLUDEFUNCNAME.varname,
            ConfVars.HIVE_AUTOGEN_COLUMNALIAS_PREFIX_LABEL.varname, ConfVars.HIVE_CHECK_CROSS_PRODUCT.varname,
            ConfVars.HIVE_CLI_TEZ_SESSION_ASYNC.varname, ConfVars.HIVE_COMPAT.varname, ConfVars.HIVE_CONCATENATE_CHECK_INDEX.varname,
            ConfVars.HIVE_DISPLAY_PARTITION_COLUMNS_SEPARATELY.varname, ConfVars.HIVE_ERROR_ON_EMPTY_PARTITION.varname,
            ConfVars.HIVE_EXECUTION_ENGINE.varname, ConfVars.HIVE_EXEC_COPYFILE_MAXSIZE.varname, ConfVars.HIVE_EXIM_URI_SCHEME_WL.varname,
            ConfVars.HIVE_FILE_MAX_FOOTER.varname, ConfVars.HIVE_INSERT_INTO_MULTILEVEL_DIRS.varname,
            ConfVars.HIVE_LOCALIZE_RESOURCE_NUM_WAIT_ATTEMPTS.varname, ConfVars.HIVE_MULTI_INSERT_MOVE_TASKS_SHARE_DEPENDENCIES.varname,
            ConfVars.HIVE_QUOTEDID_SUPPORT.varname, ConfVars.HIVE_RESULTSET_USE_UNIQUE_COLUMN_NAMES.varname,
            ConfVars.HIVE_STATS_COLLECT_PART_LEVEL_STATS.varname, ConfVars.HIVE_SCHEMA_EVOLUTION.varname,
            ConfVars.HIVE_SERVER2_LOGGING_OPERATION_LEVEL.varname, ConfVars.HIVE_SERVER2_THRIFT_RESULTSET_SERIALIZE_IN_TASKS.varname,
            ConfVars.HIVE_SUPPORT_SPECICAL_CHARACTERS_IN_TABLE_NAMES.varname, ConfVars.JOB_DEBUG_CAPTURE_STACKTRACES.varname,
            ConfVars.JOB_DEBUG_TIMEOUT.varname, ConfVars.LLAP_IO_ENABLED.varname, ConfVars.LLAP_IO_USE_FILEID_PATH.varname,
            ConfVars.LLAP_DAEMON_SERVICE_HOSTS.varname, ConfVars.LLAP_EXECUTION_MODE.varname, ConfVars.LLAP_AUTO_ALLOW_UBER.varname,
            ConfVars.LLAP_AUTO_ENFORCE_TREE.varname, ConfVars.LLAP_AUTO_ENFORCE_VECTORIZED.varname,
            ConfVars.LLAP_AUTO_ENFORCE_STATS.varname, ConfVars.LLAP_AUTO_MAX_INPUT.varname, ConfVars.LLAP_AUTO_MAX_OUTPUT.varname,
            ConfVars.LLAP_SKIP_COMPILE_UDF_CHECK.varname, ConfVars.LLAP_CLIENT_CONSISTENT_SPLITS.varname,
            ConfVars.LLAP_ENABLE_GRACE_JOIN_IN_LLAP.varname, ConfVars.LLAP_ALLOW_PERMANENT_FNS.varname,
            ConfVars.MAXCREATEDFILES.varname, ConfVars.MAXREDUCERS.varname, ConfVars.NWAYJOINREORDER.varname,
            ConfVars.OUTPUT_FILE_EXTENSION.varname, ConfVars.SHOW_JOB_FAIL_DEBUG_INFO.varname,
            ConfVars.TASKLOG_DEBUG_TIMEOUT.varname, ConfVars.HIVEQUERYID.varname,};
    
    /**
     * Default list of regexes for config parameters that are modifiable with
     * sql standard authorization enabled
     */
    static final String[] sqlStdAuthSafeVarNameRegexes = new String[]{"hive\\.auto\\..*", "hive\\.cbo\\..*", "hive\\.convert\\..*",
            "hive\\.exec\\" + ".dynamic\\.partition.*", "hive\\.exec\\.max\\.dynamic\\.partitions.*", "hive\\.exec\\.compress\\..*", "hive\\.exec\\" +
            ".infer\\." + ".*", "hive\\" + ".exec\\.mode.local\\..*", "hive\\.exec\\.orc\\..*", "hive\\.exec\\.parallel.*", "hive\\.explain\\..*",
            "hive" + "\\.fetch.task\\." + ".*", "hive\\" + ".groupby\\..*", "hive\\.hbase\\..*", "hive\\.index\\..*", "hive\\.index\\..*", "hive\\" +
            ".intermediate\\" + "..*", "hive\\.join\\." + ".*", "hive\\" + ".limit\\..*", "hive\\.log\\..*", "hive\\.mapjoin\\..*", "hive\\.merge\\..*",
            "hive\\.optimize\\" + "..*", "hive\\.orc\\..*", "hive\\" + ".outerjoin\\..*", "hive\\.parquet\\..*", "hive\\.ppd\\..*", "hive\\.prewarm\\." +
            ".*", "hive\\.server2\\" + ".thrift\\.resultset\\" + ".default\\" + ".fetch\\.size", "hive\\.server2\\.proxy\\.user", "hive\\.skewjoin\\." +
            ".*", "hive\\.smbjoin\\..*", "hive\\.stats\\..*", "hive\\" + ".strict\\." + ".*", "hive\\.tez\\..*", "hive\\.vectorized\\..*", "mapred\\" +
            ".map\\..*", "mapred\\" + ".reduce\\..*", "mapred\\.output\\" + ".compression\\.codec", "mapred\\.job\\.queuename", "mapred\\.output\\" +
            ".compression\\.type", "mapred\\.min\\.split\\.size", "mapreduce\\" + ".job\\.reduce\\" + ".slowstart\\.completedmaps", "mapreduce\\" +
            ".job\\.queuename", "mapreduce\\.job\\.tags", "mapreduce\\.input\\" + ".fileinputformat\\.split\\" + ".minsize", "mapreduce\\.map\\." +
            ".*", "mapreduce\\" + ".reduce\\..*", "mapreduce\\.output\\.fileoutputformat\\" + ".compress\\.codec", "mapreduce" + "\\.output\\" +
            ".fileoutputformat\\" + ".compress\\.type", "oozie\\..*", "tez\\.am\\..*", "tez\\.task\\..*", "tez\\.runtime\\..*", "tez\\" +
            ".queue\\.name",
    ...
    public static class StrictChecks {
        ...
        private static final String NO_LIMIT_MSG = makeMessage("Order by-s without limit", ConfVars.HIVE_STRICT_CHECKS_LARGE_QUERY);
        private static final String NO_PARTITIONLESS_MSG = makeMessage("Queries against partitioned tables without a partition filter",
        ...
        private static String makeMessage(String what, ConfVars setting) {
            return what + " are disabled for safety reasons. If you know what you are doing, please set" + setting.varname + " to false and that " + ConfVars.HIVEMAPREDMODE.varname + " is not" + " set to 'strict' to proceed. Note that if you may get errors or incorrect results if" + " you make a mistake while using some of the unsafe features.";
        }
        ...
        public static String checkNoPartitionFilter(Configuration conf) {
            return isAllowed(conf, ConfVars.HIVE_STRICT_CHECKS_LARGE_QUERY) ? null : NO_PARTITIONLESS_MSG;
        }
    ...
    /*************************************************
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释： 当你使用 hive-2.x 版本的 Hive 的时候，启动 hive 命令的时候，会给你一句关于底层执行引擎的提醒
     */
    public static String generateMrDeprecationWarning() {
        return "Hive-on-MR is deprecated in Hive 2 and may not be available in the future versions. " + "Consider using a different execution " +
                "engine (i.e. " + HiveConf
                .getNonMrEngines() + ") or using Hive 1.X releases.";
    }
