...
/**
 * TODO ASTNode 是 抽象语法树 AST 上的每个节点的抽象。
 */
        ...
        while (!stack.isEmpty()) {
            ...
            if (!next.visited) {
                ...
                if (next.children == null || next.children.size() == 0) {
                    ...
                    rootNode.addtoMemoizedString(next.getType() != HiveParser.StringLiteral ? str.toLowerCase()
                            : str);
                ...
                if (!next.isNil()) {
                    rootNode.addtoMemoizedString("(");
                    String str = next.toString();
                    rootNode.addtoMemoizedString((next.getType() == HiveParser.StringLiteral || null == str) ?
                            str : str.toLowerCase());
                    rootNode.addtoMemoizedString(" ");
                }
