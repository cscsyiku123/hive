...
public abstract class Task<T extends Serializable> implements Serializable, Node {
    ...
    public enum TaskState {
        ...
        FINISHED, // Task is just created
        CREATED, // Task state is unkown
        UNKNOWN
    }
     ...
     * where the Driver can find it.  This is checked if
     * {@link Task#execute(org.apache.hadoop.hive.ql.DriverContext)}
     * returns non-0 code.
     */
    ...
    public void initialize(
            QueryState queryState, QueryPlan queryPlan, DriverContext driverContext,
